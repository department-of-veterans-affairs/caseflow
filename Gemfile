...
gem "caseflow", git: "https://github.com/department-of-veterans-affairs/caseflow-commons", branch: "AlecK/Zeitwerk" # TODO: update to appropriate ref after caseflow-commons PR is merged

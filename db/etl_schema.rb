...
ActiveRecord::Schema[7.0].define(version: 2024_10_07_132413) do
  ...
  create_table "appeals", comment: "Denormalized BVA NODs", force: :cascade do |t|
    ...
    t.datetime "appeal_created_at", precision: nil, null: false, comment: "appeals.created_at"
    t.bigint "appeal_id", null: false, comment: "ID of the Appeal"
    t.datetime "appeal_updated_at", precision: nil, null: false, comment: "appeals.updated_at"
    ...
    t.datetime "created_at", precision: nil, null: false, comment: "Creation timestamp for the ETL record"
    ...
    t.datetime "established_at", precision: nil, null: false, comment: "Timestamp for when the appeal was intaken successfully"
    ...
    t.datetime "updated_at", precision: nil, null: false, comment: "Updated timestamp for the ETL record"
  ...
  create_table "attorney_case_reviews", comment: "Denormalized attorney_case_reviews", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: nil, null: false, comment: "Default created_at/updated_at for the ETL record"
    ...
    t.datetime "review_created_at", precision: nil, null: false, comment: "attorney_case_reviews.created_at"
    t.bigint "review_id", null: false, comment: "attorney_case_reviews.id"
    t.datetime "review_updated_at", precision: nil, null: false, comment: "attorney_case_reviews.updated_at"
    ...
    t.datetime "updated_at", precision: nil, null: false, comment: "Default created_at/updated_at for the ETL record"
  ...
  create_table "decision_documents", force: :cascade do |t|
    ...
    t.datetime "canceled_at", precision: nil, comment: "Timestamp when the job was abandoned"
    t.string "citation_number", null: false, comment: "Unique identifier for decision document"
    t.datetime "created_at", precision: nil, null: false, comment: "Default created_at/updated_at for the ETL record"
    t.date "decision_date", null: false
    t.datetime "decision_document_created_at", precision: nil, comment: "decision_documents.created_at"
    t.datetime "decision_document_updated_at", precision: nil, comment: "decision_documents.updated_at"
  ...
  create_table "decision_issues", comment: "Copy of decision_issues", force: :cascade do |t|
    ...
    t.datetime "issue_created_at", precision: nil, comment: "decision_issues.created_at"
    t.datetime "issue_deleted_at", precision: nil, comment: "decision_issues.deleted_at"
    t.datetime "issue_updated_at", precision: nil, comment: "decision_issues.updated_at"
    ...
    t.datetime "rating_profile_date", precision: nil, comment: "decision_issues.rating_profile_date"
    t.datetime "rating_promulgation_date", precision: nil, comment: "decision_issues.rating_promulgation_date"
  ...
  create_table "decision_reviews", comment: "Decision Reviews", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: nil, null: false, comment: "Default created_at/updated_at for the ETL record"
    t.datetime "decision_review_created_at", precision: nil
    ...
    t.datetime "decision_review_updated_at", precision: nil
    t.date "docket_range_date", comment: "Date that appeal was added to hearing docket range."
  ...
  create_table "etl_build_tables", comment: "ETL table metadata, one for each table per-build", force: :cascade do |t|
    ...
    t.datetime "finished_at", precision: nil, comment: "Build end time"
    ...
    t.datetime "started_at", precision: nil, comment: "Build start time (usually identical to created_at)"
  ...
  create_table "hearings", comment: "Denormalized hearings", force: :cascade do |t|
    ...
    t.datetime "hearing_created_at", precision: nil, comment: "hearings.created_at"
    t.string "hearing_day_bva_poc", comment: "hearing_days.bva_poc"
    t.datetime "hearing_day_created_at", precision: nil, comment: "hearing_days.created_at"
    ...
    t.datetime "hearing_day_deleted_at", precision: nil, comment: "hearing_days.deleted_at"
    ...
    t.datetime "hearing_day_updated_at", precision: nil, comment: "hearing_days.updated_at"
    ...
    t.datetime "hearing_location_created_at", precision: nil, comment: "hearing_locations.created_at"
    ...
    t.datetime "hearing_location_updated_at", precision: nil, comment: "hearing_locations.updated_at"
    ...
    t.datetime "hearing_updated_at", precision: nil, comment: "hearings.updated_at"
  ...
  create_table "judge_case_reviews", force: :cascade do |t|
    ...
    t.string "quality"
    t.datetime "review_created_at", precision: nil, null: false, comment: "judge_case_reviews.created_at"
    t.bigint "review_id", null: false, comment: "judge_case_reviews.id"
    t.datetime "review_updated_at", precision: nil, null: false, comment: "judge_case_reviews.updated_at"
    t.datetime "updated_at", precision: nil, null: false, comment: "Default created_at/updated_at for the ETL record"
  ...
  create_table "remand_reasons", comment: "Copy of remand_reasons", force: :cascade do |t|
    ...
    t.datetime "remand_reason_created_at", precision: nil, comment: "remand_reasons.created_at"
    t.datetime "remand_reason_updated_at", precision: nil, comment: "remand_reasons.updated_at"
    t.datetime "updated_at", precision: nil, null: false, comment: "Default created_at/updated_at for the ETL record"
  ...
  create_table "tasks", comment: "Denormalized Tasks with User/Organization", force: :cascade do |t|
    t.bigint "appeal_id", null: false, comment: "tasks.appeal_id"
    t.string "appeal_type", null: false, comment: "tasks.appeal_type"
    t.datetime "assigned_at", precision: nil, comment: "tasks.assigned_at"
    ...
    t.datetime "closed_at", precision: nil, comment: "tasks.closed_at"
    t.datetime "created_at", precision: nil, null: false, comment: "Default created_at/updated_at for the ETL record"
    t.text "instructions", default: [], comment: "tasks.instructions", array: true
    t.bigint "parent_id", comment: "tasks.parent_id"
    t.datetime "placed_on_hold_at", precision: nil, comment: "tasks.placed_on_hold_at"
    t.datetime "started_at", precision: nil, comment: "tasks.started_at"
    t.datetime "task_created_at", precision: nil, comment: "tasks.created_at"
    ...
    t.datetime "task_updated_at", precision: nil, comment: "tasks.updated_at"
    t.datetime "updated_at", precision: nil, null: false, comment: "Default created_at/updated_at for the ETL record"

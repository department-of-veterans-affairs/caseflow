class AddNewContensionsToLegacyAppeal < ActiveRecord::Migration[5.2]
  def up
    ...
    add_column :legacy_appeals, :usCourtOfAppealsForVeteransClaims, :boolean, comment: "US Court of Appeals for Veterans Claims (CAVC)"
    add_column :legacy_appeals, :no_special_issues, :boolean, comment: "Affirmative no special issues, added belatedly"
    ...
    change_column_default :legacy_appeals, :usCourtOfAppealsForVeteransClaims, false
  ...
  def down
    ...
    remove_column :legacy_appeals, :usCourtOfAppealsForVeteransClaims

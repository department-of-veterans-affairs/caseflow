class AddNewContensionsToLegacyAppeal < ActiveRecord::Migration[5.2]
  def up
    ...
    add_column :legacy_appeals, :cavc, :boolean, comment: "US Court of Appeals for Veterans Claims (CAVC)"
    ...
    change_column_default :legacy_appeals, :cavc, false
  ...
  def down
    ...
    remove_column :legacy_appeals, :cavc

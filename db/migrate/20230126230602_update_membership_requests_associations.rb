class UpdateMembershipRequestsAssociations < Caseflow::Migration
  def change
    create_table :membership_requests do |t|
      ...
      t.references :requestor, foreign_key: { to_table: :membership_requests }, comment: "The requestor for this membership"
      t.references :decider, foreign_key: { to_table: :membership_requests }, index: false, null: true, comment: "The user who decides the membership_request"

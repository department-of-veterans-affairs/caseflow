class CreateCorrespondenceIntakes < ActiveRecord::Migration[5.2]
  def change
    create_table :correspondence_intakes do |t|
      ...
      t.jsonb :added_tasks, array: true, comment: "Each object in the array will contain all relevant information to create the specific Task for either the Correspondence or the Related Appea"

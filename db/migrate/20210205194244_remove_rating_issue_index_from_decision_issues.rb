class RemoveRatingIssueIndexFromDecisionIssues < Caseflow::Migration
  ...
  def down
    ...
    change_column_comment(:decision_issues, :rating_issue_reference_id, "Identifies the specific issue on the rating that resulted from the decision issue (a rating issue can have multiple issues). This is unique per rating issue")
  end
end

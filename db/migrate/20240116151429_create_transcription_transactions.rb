class CreateTranscriptionTransactions < ActiveRecord::Migration[5.2]
  def change
    create_table :transcription_transactions do |t|
      ...
      t.datetime :date_vtt_converted, comment: "Timestamp when file was converted from vtt"
      t.datetime :date_mp4_converted, comment: "Timestamp when file was converted from mp4"
      ...
      t.string :aws_link_mp4, comment: "Link to be used by HMB to download original audio file from AWS S3"
      t.string :aws_link_vtt, comment: "Link to be used by HMB to download original transcript file from AWS S3"
      t.string :aws_link_mp3, comment: "Link to be used by HMB to download transformed audio file from AWS S3"
      t.string :aws_link_rtf, comment: "Link to be used by HMB to download transformed transcript file from AWS S3"
      t.string :aws_link_pdf, comment: "Link to be used by HMB to download pdf transcript file from AWS S3"
      t.string :aws_link_xls, comment: "Link to be used by HMB to download a transcript error file report from AWS S3"

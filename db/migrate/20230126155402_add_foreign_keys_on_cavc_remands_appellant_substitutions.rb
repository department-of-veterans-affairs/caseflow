class AddForeignKeysOnCavcRemandsAppellantSubstitutions < Caseflow::Migration
  def change
    ...
    add_foreign_key :cavc_remands_appellant_substitutions, :cavc_remands, column: "cavc_remands_id", validate: false

    add_foreign_key :cavc_remands_appellant_substitutions, :appellant_substitutions, column: "appellant_substitutions_id", validate: false
  end
end

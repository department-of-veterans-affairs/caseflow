class AddEpCorrectionFields < ActiveRecord::Migration[5.1]
  def change
    ...
    add_column :request_issues, :corrected_by_request_issue_id, :integer, null: true, comment: "The ID of the new request issue that is a correction to this incorrect request issue. This is needed for EP 930"
  end
end

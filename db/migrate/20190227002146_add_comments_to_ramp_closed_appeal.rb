class AddCommentsToRampClosedAppeal < ActiveRecord::Migration[5.1]
  def change
    ...
    change_column_comment(:ramp_closed_appeals, :closed_on, "The datetime that the legacy appeal was closed in VACOLS and opted into RAMP.")
    change_column_comment(:ramp_closed_appeals, :nod_date, "The date when the Veteran filed a Notice of Disagreement for the original claims decision in the legacy system.")
    ...
    change_column_comment(:ramp_closed_appeals, :vacols_id, "The VACOLS BFKEY of the legacy appeal that has been closed and opted into RAMP.")
  end
end

class AddNewIssuesToSpecialIssueList < ActiveRecord::Migration[5.2]
  def up
    ...
    add_column :special_issue_lists, :military_sexual_trama, :boolean, comment: "Military Sexual Trauma (MST)"
    ...
    change_column_default :special_issue_lists, :military_sexual_trama, false
  ...
  def down
    ...
    remove_column :special_issue_lists, :military_sexual_trama

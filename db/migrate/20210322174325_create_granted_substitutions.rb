class CreateGrantedSubstitutions < Caseflow::Migration
  def change
    create_table :granted_substitutions, comment: "Store Granted Substitution form data" do |t|
      ...
      t.references :source_appeal, null: false, comment: "The relevant source appeal for this substitution"
      t.references :target_appeal, null: false, comment: "The new appeal resulting from this granted substitution"

...
ActiveRecord::Schema.define(version: 2022_09_20_122149) do
  ...
  create_table "notifications", force: :cascade do |t|
    ...
    t.string "email_notification_external_id", comment: "VA Notify Notification ID for the email notification sent through their API"
    ...
    t.string "sms_notification_external_id", comment: "VA Notify Notification ID for the sms notification sent through their API"

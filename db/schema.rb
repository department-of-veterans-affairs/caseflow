...
ActiveRecord::Schema.define(version: 2024_07_17_145856) do
  ...
  create_table "example", id: false, force: :cascade do |t|
    ...
    t.string "notification_status", limit: 50
    t.string "notification_type", limit: 50
  end

  create_table "example2", id: false, force: :cascade do |t|
    t.string "email_notification_external_id", limit: 50
    t.string "email_notification_status", limit: 50
    t.string "notification_type", limit: 50
    t.string "sms_notification_external_id", limit: 50
    t.string "sms_notification_status", limit: 50
  end

  create_table "example3", id: false, force: :cascade do |t|
    t.string "email_notification_external_id", limit: 50
    t.string "email_notification_status", limit: 50
    t.string "id", limit: 50
    t.string "notification_type", limit: 50
  ...
  create_table "excel_sheet", id: false, force: :cascade do |t|
    t.string "id", limit: 50
    t.string "notification_status", limit: 50
    t.string "notification_type", limit: 50
  end

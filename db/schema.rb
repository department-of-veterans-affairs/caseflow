...
ActiveRecord::Schema.define(version: 2020_11_04_175215) do
  ...
  create_table "virtual_hearings", force: :cascade do |t|
    ...
    t.datetime "appellant_reminder_sent", comment: "The datetime the last reminder email was sent to the appellant."
    ...
    t.datetime "representative_reminder_sent", comment: "The datetime the last reminder email was sent to the representative."

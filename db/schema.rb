...
ActiveRecord::Schema.define(version: 2021_02_04_223904) do
  ...
  create_table "decision_issues", comment: "Issues that represent a decision made on a decision review.", force: :cascade do |t|
    ...
    t.string "rating_issue_reference_id", comment: "Identifies the specific issue on the rating that resulted from the decision issue (a rating can have multiple issues)."
    ...
    t.index ["rating_issue_reference_id", "disposition", "participant_id"], name: "decision_issues_by_disposition_and_ref_id"

...
ActiveRecord::Schema.define(version: 20171012214652) do
  ...
  create_table "annotations", force: :cascade do |t|
    ...
    t.integer  "y"
    t.integer  "user_id"
    t.datetime "created_at",  default: '2017-10-12 21:46:07'
    t.datetime "updated_at",  default: '2017-10-12 21:46:07'
  end

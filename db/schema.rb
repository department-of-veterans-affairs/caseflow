...
ActiveRecord::Schema.define(version: 2023_10_24_151721) do
  ...
  create_table "correspondences", force: :cascade do |t|
    ...
    t.bigint "prior_correspondence_id", null: false, comment: "Foreign key to Coreespondences table"
    ...
    t.index ["prior_correspondence_id"], name: "index_correspondences_on_prior_correspondence_id"

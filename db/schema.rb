...
ActiveRecord::Schema.define(version: 2020_07_23_134526) do
  ...
  create_table "appeals", comment: "Decision reviews intaken for AMA appeals to the board (also known as a notice of disagreement).", force: :cascade do |t|
    t.string "aod_reason", comment: "If not nil, the reason for advance-on-docket, such as 'motion' (see advance_on_docket_motions table) or 'age' if due to claimant's age."
    ...
    t.index ["aod_reason"], name: "index_appeals_on_aod_reason"

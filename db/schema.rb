...
ActiveRecord::Schema.define(version: 20190326202730) do
  ...
  create_table "appeals", force: :cascade, comment: "Decision reviews intaken for appeals to the board (also known as a notice of disagreement)." do |t|

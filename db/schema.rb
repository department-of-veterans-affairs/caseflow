...
ActiveRecord::Schema.define(version: 2023_10_20_172025) do
  ...
  create_table "correspondence_intakes", force: :cascade do |t|
    ...
    t.index ["correspondence_id"], name: "index_correspondence_intakes_on_correspondence_id"
    t.index ["user_id"], name: "index_correspondence_intakes_on_user_id"
  end

...
ActiveRecord::Schema.define(version: 2023_06_23_132146) do
  ...
  create_table "decision_issues", comment: "Issues that represent a decision made on a decision review.", force: :cascade do |t|
    ...
    t.boolean "mst", default: false, comment: "Indicates if decision issue is related to Military Sexual Trauma (MST)"
    t.boolean "pact", default: false, comment: "Indicates if decision issue is related to Promise to Address Comprehensive Toxics (PACT) Act"

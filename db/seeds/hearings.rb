  ...
  class Hearings < Base
    ...
    def create_ama_hearings_for_day(day, count)
      count.times do
        ...
        formatted_scheduled_time = "#{day.scheduled_for.to_s} #{scheduled_time} America/New_York"
    ...
    def create_ama_hearing(day:, scheduled_time_string_eastern:, issue_count: 1)
      ...
      hearing.update!(
        scheduled_datetime: hearing.time.ama_scheduled_for(scheduled_time_string_eastern)
      )
    ...
    def create_legacy_hearing(day:, scheduled_time_string_eastern:)
      ...
      case_hearing.update!(
        hearing_date: hearing.time.legacy_scheduled_for(scheduled_time_string_eastern)
      )

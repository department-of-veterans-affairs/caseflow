  ...
  class AojRemandReturnLegacyAppeals < Base
    ...
    def create_cases_for_aoj_aod_affinty_days_lever
      # aoj aod affinity cases:
        ...
        create(:legacy_aoj_appeal, :aod, bfcorlid: "#{create_correspondent.ssnn}S", judge: affinity_and_tied_to_judge, attorney: attorney, tied_to: false, appeal_affinity: false)
        ...
        VACOLS::Case.where(bfcorlid: ca1.bfcorlid, bfac: "7").update(bfmemid: affinity_judge.sattyid)
        ...
        VACOLS::Case.where(bfcorlid: ca2.bfcorlid, bfac: "7").update(bfmemid: affinity_judge.sattyid)
        ...
        VACOLS::Case.where(bfcorlid: ca3.bfcorlid, bfac: "7").update(bfmemid: affinity_judge.sattyid)

        ca4 = create(:legacy_aoj_appeal, :aod, bfcorlid: "#{create_correspondent.ssn}S", judge: other_judge, attorney: attorney)
        VACOLS::Case.where(bfcorlid: ca4.bfcorlid, bfac: "7").update(bfmemid: affinity_judge.sattyid)

        ca5 = create(:legacy_aoj_appeal, :aod, bfcorlid: "#{ccreate_correspondent.ssn}S", judge: other_judge, attorney: attorney, affinity_start_date: 3.days.ago)
        VACOLS::Case.where(bfcorlid: ca5.bfcorlid, bfac: "7").update(bfmemid: affinity_judge.sattyid)
        ...
        VACOLS::Case.where(bfcorlid: ca6.bfcorlid, bfac: "7").update(bfmemid: affinity_judge.sattyid)
        ...
        VACOLS::Case.where(bfcorlid: ca7.bfcorlid, bfac: "7").update(bfmemid: nil)

        ca8 = create(:legacy_aoj_appeal, :aod, bfcorlid: "#{create_correspondent.ssn}S", judge: affinity_and_tied_to_judge, attorney: attorney)
        VACOLS::Case.where(bfcorlid: ca8.bfcorlid, bfac: "7").update(bfmemid: nil)
        ...
        VACOLS::Case.where(bfcorlid: ca9.bfcorlid, bfac: "7").update(bfmemid: nil)
        ...
        VACOLS::Case.where(bfcorlid: ca10.bfcorlid, bfac: "7").update(bfmemid: nil)
    end
    ...
    def create_cases_for_aoj_aod_affinty_days_lever_excluded_judge
      # excluded judge cases:
        ...
        VACOLS::Case.where(bfcorlid: ca11.bfcorlid, bfac: "7").update(bfmemid: excluded_judge.sattyid)
        ...
        VACOLS::Case.where(bfcorlid: ca12.bfcorlid, bfac: "7").update(bfmemid: excluded_judge.sattyid)
        ...
        VACOLS::Case.where(bfcorlid: ca13.bfcorlid, bfac: "7").update(bfmemid: excluded_judge.sattyid)

        # hearing held with previous decision where judge is same (THIS IS TIED TO)
        create(:legacy_aoj_appeal, :aod, bfcorlid: "#{create_correspondent.ssn}S", judge: excluded_judge, attorney: attorney)
        create(:legacy_aoj_appeal, :aod, bfcorlid: "#{ccreate_correspondent.ssn}S", judge: excluded_judge, attorney: attorney, affinity_start_date: 3.days.ago)
    ...
    def create_cases_for_aoj_aod_affinity_days_lever_ineligible_judge
      # ineligible judge cases:
        ...
        VACOLS::Case.where(bfcorlid: ca14.bfcorlid, bfac: "7").update(bfmemid: ineligible_judge.sattyid)
        ...
        VACOLS::Case.where(bfcorlid: a17.bfcorlid, bfac: "7").update(bfmemid: ineligible_judge.sattyid)
    end
  end
end

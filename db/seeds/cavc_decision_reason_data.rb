...
module Seeds
  class CavcDecisionReasonData < Base
    ...
    def create_cavc_decision_reasons
      ...
      parent_reason_1 = CavcDecisionReason.create(decision_reason: "Duty to assist", order: 2)
      ...
      parent_reason_2 = CavcDecisionReason.create(decision_reason: "Provide VA examination", order: 9)
      parent_reason_3 = CavcDecisionReason.create(decision_reason: "Obtain VA opinion", order: 10)
      CavcDecisionReason.create(decision_reason: "Other statutory or regulatory duty", order: 11)
      parent_reason_4 = CavcDecisionReason.create(decision_reason: "Consider statute/regulation/diagnostic code/caselaw",
                                           order: 12)
      ...
      parent_reason_5 = CavcDecisionReason.create(
      ...
      parent_reason_6 = CavcDecisionReason.create(decision_reason: "AMA specific remand?", order: 18)

      # decision reason children
      # Parent: Duty to assist
      CavcDecisionReason.create(decision_reason: "Treatment records", parent_decision_reason_id: parent_reason_1.id, order: 1)
      CavcDecisionReason.create(decision_reason: "Service records (medical/personnel)",
                                parent_decision_reason_id: parent_reason_1.id, order: 2)

      # Parent: Provide VA examination
      CavcDecisionReason.create(decision_reason: "Prior examination inadequate", parent_decision_reason_id: parent_reason_2.id,
                                basis_for_selection_category: :prior_examination_inadequate, order: 1)
      CavcDecisionReason.create(decision_reason: "No VA examination provided", parent_decision_reason_id: parent_reason_2.id,
                                order: 2)

      # Parent: Obtain VA opinion
      CavcDecisionReason.create(decision_reason: "Prior opinion inadequate", parent_decision_reason_id: parent_reason_3.id,
                                basis_for_selection_category: :prior_opinion_inadequate, order: 1)
      CavcDecisionReason.create(decision_reason: "No VA opinion provided", parent_decision_reason_id: parent_reason_3.id,
                                order: 2)

      # Parent: Consider statute/regluation/diagnostic code/caselaw
      CavcDecisionReason.create(decision_reason: "Statute", parent_decision_reason_id: parent_reason_4.id,
                                basis_for_selection_category: :consider_statute, order: 1)
      CavcDecisionReason.create(decision_reason: "Regulation", parent_decision_reason_id: parent_reason_4.id,
                                basis_for_selection_category: :consider_regulation, order: 2)
      CavcDecisionReason.create(decision_reason: "Diagnostic code", parent_decision_reason_id: parent_reason_4.id,
                                basis_for_selection_category: :consider_diagnostic_code, order: 3)
      CavcDecisionReason.create(decision_reason: "Caselaw", parent_decision_reason_id: parent_reason_4.id,
                                basis_for_selection_category: :consider_caselaw, order: 4)

      # Parent: Misapplication of statute/regulation/diagnostic code/caselaw
      CavcDecisionReason.create(decision_reason: "Statute", parent_decision_reason_id: parent_reason_5.id,
                                basis_for_selection_category: :misapplication_statute, order: 1)
      CavcDecisionReason.create(decision_reason: "Regulation", parent_decision_reason_id: parent_reason_5.id,
                                basis_for_selection_category: :misapplication_regulation, order: 2)
      CavcDecisionReason.create(decision_reason: "Diagnostic code", parent_decision_reason_id: parent_reason_5.id,
                                basis_for_selection_category: :misapplication_diagnostic_code, order: 3)
      CavcDecisionReason.create(decision_reason: "Caselaw", parent_decision_reason_id: parent_reason_5.id,

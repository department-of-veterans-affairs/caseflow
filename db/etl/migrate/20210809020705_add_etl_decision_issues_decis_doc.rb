...
class AddEtlDecisionIssuesDecisDoc < Caseflow::Migration
  def change
    ...
    add_column :decision_issues, :doc_decision_date, :datetime,
               comment: "Decision date of associated decision document"
    add_column :decision_issues, :doc_uploaded_to_vbms_at, :datetime,
               comment: "Date when associated decision document was uploaded to VBMS"

    add_column :decision_issues, :judge_task_id, :bigint,
               comment: "Id of associated judge task"
    add_column :decision_issues, :judge_user_id, :bigint,
               comment: "Id of associated judge user"
    add_column :decision_issues, :judge_css_id, :string,
               comment: "CSS_ID of associated judge"

    add_column :decision_issues, :attorney_task_id, :bigint,
               comment: "Id of associated attorney task"
    add_column :decision_issues, :attorney_user_id, :bigint,

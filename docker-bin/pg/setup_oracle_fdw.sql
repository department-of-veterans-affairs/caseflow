...
-- local_host_port = 1521
-- vacols_user = 'VACOLS_DEV'
-- vacols_password = 'VACOLS_DEV'
...
-- Set the dbserver to point to the localhost on the port it uses to query VACOLS
CREATE SERVER vacols_sv FOREIGN DATA WRAPPER oracle_fdw OPTIONS (
    dbserver 'localhost:{local_host_port}/BVAP'
);

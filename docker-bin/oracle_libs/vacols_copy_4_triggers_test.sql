...
CREATE OR REPLACE TRIGGER "VACOLS_TEST"."ISSUES_ISSDEV" BEFORE
UPDATE OF "ISSDC", "ISSDEV" ON "VACOLS_TEST"."ISSUES" REFERENCING
...
CREATE OR REPLACE TRIGGER "VACOLS_TEST"."HEARSCHED_INSERT" BEFORE
INSERT ON
VACOLS_TEST.HEARSCHED
REFERENCING
...
CREATE OR REPLACE TRIGGER "VACOLS_TEST"."BRIEFF_TBREADY" BEFORE
INSERT OR
UPDATE OF "BFDTBREADY", "BFTBIND" ON "VACOLS_TEST"."BRIEFF" REFERENCING
...
CREATE OR REPLACE TRIGGER "VACOLS_TEST"."REP_INSERT" BEFORE
INSERT ON
"VACOLS_TEST"."REP"
REFERENCING
OLD AS OLD NEW AS NEW FOR EACH ROW
...
CREATE OR REPLACE TRIGGER "VACOLS_TEST"."SOC_ATTID" BEFORE
UPDATE OF "SOCATTID", "SOCATTID2" ON "VACOLS_TEST"."SOC" REFERENCING
OLD AS OLD NEW AS NEW FOR EACH ROW   WHEN
...
UPDATE OF "TISUBJ1" ON "VACOLS_TEST"."FOLDER" FOR EACH ROW
BEGIN
...
INSERT
OR
UPDATE OF "CVJMR" ON "VACOLS_TEST"."COVA" FOR EACH ROW
BEGIN
...
CREATE OR REPLACE TRIGGER "VACOLS_TEST"."BRIEFF_DVDATES" BEFORE
UPDATE OF "BFCURLOC", "BFDCFLD3", "BFDDRO", "BFDDVIN", "BFDDVOUT", "BFDDVWRK", "BFDLOOUT" ON "VACOLS_TEST"."BRIEFF" REFERENCING
OLD AS OLD NEW AS NEW FOR EACH ROW
BEGIN
...
CREATE OR REPLACE TRIGGER "VACOLS_TEST"."ADTIME_MODIFY" BEFORE
UPDATE OF "AD113NOREC", "ADCASEDIST", "ADCASEINTAKE", "ADDOR", "ADIHP", "ADMODTIME", "ADMODUSER", "ADSPECPTS", "ADSTAFKEY", "ADTASC", "ADTRANSPG", "ADWEEK", "SPECPTSDESCP" ON "VACOLS_TEST"."ADMINTIME" REFERENCING
OLD AS OLD NEW AS NEW FOR EACH ROW
BEGIN

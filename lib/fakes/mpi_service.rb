          ...
          { patient:
            { id:
              ...
              { name: { :given => ["MADISON", "C"], :family => "WESTBROOK", :@use => "L" },
                administrative_gender_code: { :@code => "F" },
                birth_time: { :@value => "19930125" },
                as_other_i_ds: [{ id: { :@extension => "627014685", :@root => "2.16.840.1.113883.4.1" },
                                  status_code: { :@code => "4" },
                                  :scoping_organization =>
                   { id: { :@root => "1.2.840.114350.1.13.99997.2.3412" },
                     :@class_code => "ORG",
              ...
              :subject_of1 =>
              { query_match_observation: { :code => { :@code => "IHE_PDQ" },
                                           :value => { :"@xsi:type" => "INT", :@value => "135" },
                                           :@class_code => "COND",
                                           :@mood_code => "EVN" } },
              :subject_of2 =>
          ...
          { patient:
            { id:
              ...
              { name: { :given => ["MADISON", "E"], :family => "WESTBROOK", :@use => "L" },
                administrative_gender_code: { :@code => "F" },
                birth_time: { :@value => "19930125" },
                as_other_i_ds: [{ id: { :@extension => "627014687", :@root => "2.16.840.1.113883.4.1" },
                                  status_code: { :@code => "4" },
                                  :scoping_organization =>
                   { id: { :@root => "1.2.840.114350.1.13.99997.2.3412" },
                     :@class_code => "ORG",
          ...
          { patient:
            { id:
              ...
              { name: { :given => ["MADISON", "D"], :family => "WESTBROOK", :@use => "L" },
                administrative_gender_code: { :@code => "F" },
                birth_time: { :@value => "19930125" },
                as_other_i_ds: [{ id: { :@extension => "627014686", :@root => "2.16.840.1.113883.4.1" },
                                  status_code: { :@code => "4" },
                                  :scoping_organization =>
                   { id: { :@root => "1.2.840.114350.1.13.99997.2.3412" },
                     :@class_code => "ORG",
        ...
        registration_event: {
          ...
          { patient:
            { id:
              ...
              status_code: { :@code => "active" },
              :patient_person =>
              { name: [{ :given => ["MADISON", "ANNE"], :family => "WESTBROOK", :@use => "L" },
                       { :family => "GRANGER", :@use => "C" }],
                telecom: { :@use => "HP", :@value => "(555)463-1987" },
                administrative_gender_code: { :@code => "F" },
                birth_time: { :@value => "19930114" },
                multiple_birth_ind: { :@value => "false" },
                addr: { :street_address_line => "3318 GONDAR AVENUE",
                        :city => "LONG BEACH",
                        :state => "CA",
                        :postal_code => "90808",
                        :country => "USA",
                        :@use => "PHYS" },
                as_other_i_ds: { id: { :@extension => "627014683", :@root => "2.16.840.1.113883.4.1" },
                                 status_code: { :@code => "4" },
                                 :scoping_organization =>
                  { id: { :@root => "1.2.840.114350.1.13.99997.2.3412" },
                    :@class_code => "ORG",
          ...
          { patient:
            { id:
              ...
              { name: { :given => ["MADISON", "F"], :family => "WESTBROOK", :@use => "L" },
                administrative_gender_code: { :@code => "F" },
                birth_time: { :@value => "19930125" },
                as_other_i_ds: [{ id: { :@extension => "627014688", :@root => "2.16.840.1.113883.4.1" },
                                  status_code: { :@code => "4" },
                                  :scoping_organization =>
                   { id: { :@root => "1.2.840.114350.1.13.99997.2.3412" },
                     :@class_code => "ORG",
          ...
          { patient:
            { id:
              ...
              { name: { :given => ["MADISON", "H"], :family => "WESTBROOK", :@use => "L" },
                administrative_gender_code: { :@code => "F" },
                birth_time: { :@value => "19930126" },
                as_other_i_ds: [{ id: { :@extension => "627014690", :@root => "2.16.840.1.113883.4.1" },
                                  status_code: { :@code => "4" },
                                  :scoping_organization =>
                   { id: { :@root => "1.2.840.114350.1.13.99997.2.3412" },
                     :@class_code => "ORG",
        ...
        registration_event: {
          ...
          { patient:
            { id:
              ...
              status_code: { :@code => "active" },
              :patient_person =>
              { name: [{ :given => ["MADISON", "ANNA"], :family => "WESTBROOK", :@use => "L" },
                       { :family => "FARNSWORTH", :@use => "C" }],
                telecom: { :@use => "HP", :@value => "(555)496-8237" },
                administrative_gender_code: { :@code => "F" },
                birth_time: { :@value => "19930113" },
                multiple_birth_ind: { :@value => "false" },
                addr: { :street_address_line => "4958 Pearce Ave",
                        :city => "Lakewood",
                        :state => "CA",
                        :postal_code => "90712",
                        :country => "USA",
                        :@use => "PHYS" },
                as_other_i_ds: { id: { :@extension => "627014682", :@root => "2.16.840.1.113883.4.1" },
                                 status_code: { :@code => "4" },
                                 :scoping_organization =>
                  { id: { :@root => "1.2.840.114350.1.13.99997.2.3412" },
                    :@class_code => "ORG",

...
module Constants::AttorneyJudgeTeams
  ...
  JUDGES = {
    ...
    prod: {
      ...
      "BVAMHERMAN" => { attorneys: %w[VACOMEINEK VACOGOREHA VACOALHINM BVAJBURRO BVATDOUGLAS VACOGRZECT VACOHUMPHD VACOLEEM2 BVAMMAC VACOREKOWE VACOSAINDP] },
      ...
      "BVAJFRANCIS" => { attorneys: %w[VACOSELLES	VACONESMIC VACODICKET BVACHOUBECK BVAJSCHROADER BVASHOOPEN BVAKKARDIAN VACOFITZGT VACOONGG VACOHARNEC1] },

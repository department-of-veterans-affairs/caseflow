...
module Constants::AttorneyJudgeTeams
  ...
  JUDGES = {
    ...
    prod: {
      ...
      "VACOWHITEY" => { attorneys: %w[VACOMURPHE5 VACOGLAESJ VACOABDELD BVAABARNER BVATSYKES VACOCHOC BVAALECH VACOLILLYG BVAMMOORE BVAPOLSON] },
      ...
      "BVAMTENNER" => { attorneys: %w[VACOXIONGD BVADDONAHUE BVATYHAWKINS VACOXIONGD VACOVASSAM BVASPATEL BVAJESSMITH BVATYHAWKINS VACOWHITEB4 VACOPENDLN VACOPRATTV] },
      ...
      "BVAAJAEGER" => { attorneys: %w[BVANNORTHCUTT VACOALMOSR VACOALSTOT VACOGAYEE VACOBROOKB4 BVAMOLSON VACOCLARKK1 VACOESTESJ VACOSTANTK] },
      ...
      "BVADHACHEY" => { attorneys: %w[VACOBALLID VACOZHENGA3 BVACASKOW VACOLJBAKKE BVADLEE BVASDELHAUER VACOMINEE VACOSCHICS VACOBRANDK1 VACOSALAZM] },
      ...
      "BVAMDONOHUE" => { attorneys: %w[VACOMAKONM VACOAHSANN VACOJONEST] },

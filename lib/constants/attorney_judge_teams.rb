...
module Constants::AttorneyJudgeTeams
  ...
  JUDGES = {
    ...
    prod: {
      ...
      "BVATKONYA" => { attorneys: %w[VACOGRESHT BVASPFLUGNER BVANMCELWAIN BVAAHAMPTON BVAGFRASER VACOFERGUA VACONELSOL3 VACOWINBUB VACOMARTIC9] },
      ...
      "BVASBELCHER" => { attorneys: %w[VACOROSSS1 BVARCASADEI VACOFARREB2 VACOHARPET BVAJLEE VACOLOGANL1 BVAJNICHOLS BVAMTHOMAS VACOYAFFEA] },
      ...
      "BVASDREISS" => { attorneys: %w[VACOIJITIK VACOJONEST1 BVAJCASTILLO VACOJORDANJ BVAJKITLAS BVASREGAN BVACSAMUELSON BVATWESNER BVAMAWILSON] },
      ...
      "BVAHSCHARTZ" => { attorneys: %w[VACOSTRIKS BVANRIPPEL BVAASYED BVAMSUFFOLE BVARSTEPHENS VACOYOFFEP VACOSHANNG VACOCREEGA] },

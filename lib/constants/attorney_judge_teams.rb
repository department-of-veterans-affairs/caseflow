...
module Constants::AttorneyJudgeTeams
  ...
  JUDGES = {
    ...
    prod: {
      ...
      "BVALREIN" => { attorneys: %w[VACOPITTSA VACOPARRIA BVAJSHAW VACOBARBEM2 VACOCOOGAJ VACODELLAA BVASFINN BVACRYAN VACOKOE] },
      "BVAMHAWLEY" => { attorneys: %w[VACOKELLYD BVAMRILEY BVATGRIFFIN BVAGSLOVICK BVABWILLIAMS BVAWRIPP VACOMORRISJ VACOFERGUS1 VACONORWOA] },
      ...
      "BVAVMOSHI" => { attorneys: %w[VACOKUCERC BVAMYUAN BVATMATTA VACOSHOWAM VACOROBINN VACODAILLM VACOLAMBES] },
      ...
      "BVAMSORISIO" => { attorneys: %w[VACOWHITEM5 BVALWGREEN BVABYOON BVALYANTZ BVAKWALTERS VACOSTALLL VACOPATELS VACOBREITN VACODEANR2] },
      ...
      "BVALHOWELL" => { attorneys: %w[VACOHAMILD1 VACOKOKOLT BVAEREDMAN BVAKSCHAEFER BVAKKOVAROVIC VACOYACOUM VACOSPIGEA VACOBERNAT VACOEVANSB] },
      ...
      "BVAVCLEMENT" => { attorneys: %w[VACOEMMART VACOANWARS2 VACOCOHENB VACOCOLLEC BVAGJACKSON BVAJMILLER VACOMILLEN2 VACOWOZNIJ] },
      "BVAMLKANE" => { attorneys: %w[VACOHOYG BVALMOLLAN VACOGALANM BVAKHUBERS VACOJANOFR BVAMLAVAN VACOLEAMOJ VACOPARSOA] },
      ...
      "BVAAJAEGER" => { attorneys: %w[VACOGAYEE VACOBROOKB4 BVAMOLSON VACOCLARKK1 VACOESTESJ VACOHTUNL BVAAPANIO BVAKSOSNA VACOSTANTK] },
      ...
      "BVAMJSKALT" => { attorneys: %w[VACOMONTAA VACOCANNOB BVASDALE VACODANIEA2 VACODAUGHP VACOGARCIAJ VACORESCAM BVASSHOREMAN] },
      ...
      "BVAHWALKER" => { attorneys: %w[VACOMMEJEN BVAALINDIO BVAKGIELOW BVAMMCPHAULL BVAMLUBOCH BVAESKIOURIS VACOPRICEA VACOTALAMT VACODECHIA] },
      ...
      "BVAVCHIAPP" => { attorneys: %w[VACODUPRED BVALCROHE BVADEBAUGH BVAJSPRINGER VACOJOHNSP2 VACOWILLIL12 VACOGIAQUM VACOBROZYK] },
      ...
      "BVAESLEBOFF" => { attorneys: %w[VACOSHELTA BVACECKART BVACHANDY BVAMKREINDLER BVAMPREM BVAWSNYDER VACOHURLES VACOGRIFFJ] },
      "BVAPSORISIO" => { attorneys: %w[VACOHAND BVAJPRICHRD BVAPLOPEZ VACOSHOUMM VACOWILLIA5 VACOCRUZK VACOGELBEJ VACOMORALG] },
      ...
      "BVAKBCONNER" => { attorneys: %w[VACOSEEHUS VACOBEHLER BVAKBUCKLEY VACOFAVERA BVACHERJONES VACOKLEPOK BVALKSTRAUSS VACOWALKER VACOYUNH BVAKCHANCE] }
    }
  }.freeze

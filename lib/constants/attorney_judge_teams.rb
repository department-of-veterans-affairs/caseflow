...
module Constants::AttorneyJudgeTeams
  ...
  JUDGES = {
    ...
    prod: {
      ...
      "BVAJHWA" => { attorneys: %w[VACOMUCKLP VACOMUZZAR VACONEGROJ VACOFORDC BVAKPARKE VACOFREEMJ2 BVACCYKOWSKI VACOBUSHL2 VACOCASEYC] },
      ...
      "BVABMULLINS" => { attorneys: %w[VACOKUTROA VACOJOCHES VACOTEICHC BVASCHINNERER BVAPVERESINK BVAANOLLEY VACOKUTROA VACOLEEY1 VACOFISHEH VACOWHITAN VACOTROTTR VACOKINGT10] },
      ...
      "BVANKROES" => { attorneys: %w[VACORUDOLR VACOSHUSTM BVACBOYD BVADHAVELKA BVARVELDENZ BVAEBRANDAU BVAAWEIS VACOGONZAM6 VACOSCARDR] },
      ...
      "BVARKESSEL" => { attorneys: %w[VACOBECTOS BVACBOSELY BVAPCHILDERS VACOGEORGEJ BVABISAACS VACOJIMERD BVAASANTIAGO BVAMTAYLOR VACOGRAYE VACOMORFOS VACOPAGANW] },

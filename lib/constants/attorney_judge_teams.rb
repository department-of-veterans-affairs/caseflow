...
module Constants::AttorneyJudgeTeams
  ...
  JUDGES = {
    ...
    prod: {
      ...
      "BVARKESSEL" => { attorneys: %w[BVACBOSELY BVAPCHILDERS VACOGEORGEJ BVABISAACS VACOJIMERD BVAASANTIAGO BVAMTAYLOR VACOGRAYE VACOMORFOS VACOPAGANW] },
      ...
      "BVAKMILLIKAN" => { attorneys: %w[VACOBRUTOC BVASGINSKI BVADSNELSON VACONGUYEP BVACSMITH BVAHYOO] },
      "BVATOSHAY" => { attorneys: %w[BVASFLOT BVAJRBRYANT BVAJCHENG BVAJFLYNN VACOKALOLS BVACLKRAS BVAKMITCHELL VACOPEDENN VACOHITED BVACKAMMEL] },
      ...
      "BVAKALIBRAN" => { attorneys: %w[VACOSTEELE BVAJMURRAY BVAJKESELYAK BVASREED VACOVANGS VACOBAXTES VACOMARSHA VACOMCDONK4] },

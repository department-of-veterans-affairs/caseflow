...
module Constants::AttorneyJudgeTeams
  ...
  JUDGES = {
    ...
    prod: {
      "BVADAMES" => { attorneys: %w[VACOWILLOL BVATBLAKE VACOBRUNOR VACOFOWLEJ BVARFRANK BVAJLYONS VACORIORDB BVAAROCK VACOSTEVEN] },
      "VACOCARACA" => { attorneys: %w[VACOCRAWFL VACODEEMEG VACOGANDHR VACOJOSEPT BVAJTRICKEY VACOWALKEW BVAGFENICE BVATMINOT] },
      "BVAKHADDOCK" => { attorneys: %w[VACOWHITLD1 VACOQUANTC BVAICANNADAY BVASKRUNIC BVASMISHA VACOODONNC VACOSAMIA BVAASHAWKEY VACOSIMM VACOWARED] },
      "BVAMDLYON" => { attorneys: %w[VACOSCANLK VACOFRANKP VACOHARRIM30 BVAMMILLER BVACMURRAY BVASSIESSER VACOTAYLOY] },
      "BVAAMAINELLI" => { attorneys: %w[BVAHJHARTER BVACHOWELL VACONARDUV VACOOCONNM BVACORIE VACORASOON VACOREIDJ BVATWILLIE] },
      "VACOSTROMG" => { attorneys: %w[VACOSHERMC BVAJADAVIS BVAHBROKOWSKY VACOGROSSC VACOLAFFIK VACOSAHRAZ BVAMSCHLICK VACOSMITHA5 BVAKSPRAGINS] },
      "VACOWHITEY" => { attorneys: %w[VACOGLAESJ VACOABDELD BVAABARNER BVATSYKES VACOCHOC BVAALECH VACOLILLYG BVAMMOORE BVAPOLSON] },
      "BVADWIGHT" => { attorneys: %w[VACOBRISTK VACOBLAKER VACOMILLEE VACONELSOJ BVAMNYE VACORAJS BVAPRUBIN VACOTIMBEM BVARWATKINS] },
      "BVAJWILLS" => { attorneys: %w[VACOCHILCD1 VACOKUCZYR BVAKOSEGUEDA BVAMPOSTEK BVABRIDEOUT BVAJSAIKH VACOWALKEK3 BVAMWULFF] },
      "BVAPMLYNCH" => { attorneys: %w[VACOGRIFFA1 VACOHAASJ BVAJRUTKIN BVALMCCABE BVANSANGSTER BVAMPURDUM VACOSTEDMM VACODENTOB VACOSINCKL VACOMUSSES2 VACOEDWARC] },
      "BVASKENNEDY" => { attorneys: %w[VACOJAMIEA VACOSMITHM2 BVAJCONOLLY BVACWASSER BVASBARIAL BVASSPICKNALL BVAMCOYNE VACOCOSTEJ1 VACOBATTER VACOFLOORN VACOFLEURG] },
      "BVANDOAN" => { attorneys: %w[VACOROBINC6 VACOMOOREY VACODELLAA VACOTHOMPK3 VACOSOLOMS BVAAHEMPHILL BVAADJAKSON BVAADEAN BVAAGIBSON BVAADEAN BVADDONAHUE BVAAHEMPHILL VACOSOLOMS VACODERMAM VACOTHOMPK3 VACOMOOREY BVAAGIBSON VACOKASSC] },
      "BVADBROWN" => { attorneys: %w[VACOHINESA1 VACOVOIGHB VACOFERRAC BVAMCARSTEN BVAHABEACH BVAMRUDE VACOMONTAJ VACOBAMETP VACOBOOKET VACOKERPAA] },
      ...
      "BVAMTENNER" => { attorneys: %w[BVADDONAHUE BVATYHAWKINS VACOXIONGD VACOVASSAM BVASPATEL BVAJESSMITH BVATYHAWKINS VACOWHITEB4 VACOPENDLN VACOPRATTV] },
      "BVAJHWA" => { attorneys: %w[BVASSPICKNALL VACOVOIGHB BVASSLEEMI VACOMUZZAR VACONEGROJ VACOFORDC BVAKPARKE VACOFREEMJ2 BVACCYKOWSKI VACOBUSHL2 VACOCASEYC] },
      "BVALREIN" => { attorneys: %w[VACODERMAM BVALNOTTLE VACOMAHAFC VACOPITTSA VACOPARRIA BVAJSHAW VACOBARBEM2 BVACRYAN VACOKOE] },
      "BVAMHAWLEY" => { attorneys: %w[VACOBLACKT3 VACOHODGEB VACOKELLYD BVAMRILEY BVATGRIFFIN BVAGSLOVICK BVABWILLIAMS BVAWRIPP VACOMORRISJ VACOFERGUS1 VACONORWOA] },
      "BVAAMACKEN" => { attorneys: %w[VACOBANKSB1 VACOHICKSE BVAMYOUNG BVALBARSTOW BVAALEVANS BVAJABRAMS BVACCOLLINS VACOQUARLB VACOMUKHEC VACOBANKSC4] },
      "BVAGRSENYK" => { attorneys: %w[VACONAUMOA VACOCORDIE BVAJRSIEGEL BVADBREITBEIL BVADSCHECH VACOSKOWRW BVAJDUPONT VACOBAYLESJJ VACOSTASKN VACOPOINDP] },
      "BVAVMOSHI" => { attorneys: %w[VACOMCKONK VACOBRYANA ACOMCKONK VACOARRITD VACOKUCERC BVAMYUAN BVATMATTA VACOROBINN VACODAILLM VACOLAMBES] },
      "BVAMCGRAHAM" => { attorneys: %w[VACOMCCORD VACOVASHAM BVACLAWSON BVAKHUGHES BVASKREITLOW BVAABARONE BVATWISHARD VACOHERDLB2 VACOFALEST VACOANDERC12] },
      "BVAMELARKIN" => { attorneys: %w[VACOWILLIN22 VACOMARRAK BVAJRDAVIT BVARBURRIESCI BVARPATNER BVAJKOMPERDA BVACBIGGINS BVAESTRUENING VACOPERKIM5 VACOMCLEOP] },
      ...
      "BVAVELEZE" => { attorneys: %w[VACOKERNEI VACOJAVEDT VACOBAROND BVAKWALLIN VACOFOSTEK5 VACOSANDLJ VACOARNOLA2 VACOROEA] },
      "BVATKONYA" => { attorneys: %w[VACOROBERD1 VACOGRESHT BVASPFLUGNER BVANMCELWAIN BVAAHAMPTON BVAGFRASER VACONELSOL3 VACOMARTIC9] },
      "BVAURPOWELL" => { attorneys: %w[VACOPARSOS VACOKUTROA VACOLEARYS BVAABUDD BVAAFLAMINI BVAJHENRIQUEZ BVAMESPINOZA VACOBAKERJH VACOLEMOIB] },
      ...
      "BVALJENG" => { attorneys: %w[VACOMAKONM BVAAALDERMAN BVAMJIN BVADSCHECHT VACORAFTEG VACOBROWNN6 VACOINNETL VACOFREEMS] },
      "BVABMULLINS" => { attorneys: %w[VACOJOCHES VACOTEICHC BVASCHINNERER BVAPVERESINK BVAANOLLEY VACOLEEY1 VACOFISHEH VACOWHITAN VACOTROTTR VACOKINGT10] },
      "BVALHOWELL" => { attorneys: %w[VACORAGOFD VACOHAMILD1 VACOKOKOLT BVAEREDMAN BVAKSCHAEFER BVAKKOVAROVIC VACOYACOUM VACOSPIGEA VACOEVANSB] },
      "BVAKBANFIELD" => { attorneys: %w[VACOASAREA VACOWILSOG BVAJJENKINS BVADCAMILLERI BVAWMYATES BVACBANISTER VACOMEDINS VACOMAMISR VACOBIRDEM] },
      "BVANKROES" => { attorneys: %w[VACORUDOLR VACOSHUSTM BVACBOYD BVADHAVELKA BVARVELDENZ BVAAWEIS VACOGONZAM6 VACOSCARDR] },
      ...
      "BVAMLKANE" => { attorneys: %w[VACOLEEC4 VACOREYNOP VACOHOYG BVALMOLLAN VACOGALANM BVAKHUBERS VACOJANOFR BVAMLAVAN VACOLEAMOJ VACOPARSOA] },
      "BVAJBKRAMER" => { attorneys: %w[VACOJACKMB VACOCAPESK VACOBERNAT1 BVALMCRAMP VACODUTHEE BVAJGALLAGHER BVAAMACK BVAJRAGHEB VACORAYMOS VACOSCHNIM BVATSHERR] },
      "BVASBELCHER" => { attorneys: %w[VACOSTRINA VACOWAGNED2 VACOROSSS1 BVARCASADEI VACOFARREB2 VACOHARPET BVAJLEE VACOLOGANL1 BVAJNICHOLS BVAMTHOMAS VACOYAFFEA] },
      "BVAKPARAKAL" => { attorneys: %w[VACONGUYEA1 VACODAVISM2 VACOCARMAF BVAPJOHNS BVATSKELLY BVACKUNG BVAKKUNZ VACOOWENSS BVARFWILLIAMS VACOWOODAM] },
      "BVAJPARKER" => { attorneys: %w[VACOCOSTAD VACOMILLEE1 VACODYER VACOBEDFOA BVAEBLOWERS VACOCHOIE1 BVACPALMER VACOMOORES BVAATENNEY] },
      "BVAHSEESEL" => { attorneys: %w[VACORUSSET VACOIANNOE VACOBOALA BVAACHRIST BVARCONNALLY BVATHJONES VACOJONESE20 BVANNELSON VACOTEAGUC3] },
      ...
      "BVAAJAEGER" => { attorneys: %w[BVANNORTHCUTT VACOALMOSR VACOALSTOT VACOGARDNE VACOBROOKB4 BVAMOLSON VACOCLARKK1 VACOESTESJ VACOSTANTK] },
      "BVADJOHNSON" => { attorneys: %w[VACOAOUGHM VACOLAURID VACOBARRED BVAMGMAZUCH BVAMSOBIECKI VACOTANGM VACOVUONGK VACOMORTIE] },
      ...
      "BVAMJSKALT" => { attorneys: %w[VACODEBOEC VACOKINGJ VACOMONTAA VACOCANNOB BVASDALE VACODANIEA2 VACODAUGHP VACOGARCIAJ VACORESCAM BVASSHOREMAN] },
      "BVARKESSEL" => { attorneys: %w[VACOBECTOS BVACBOSELY VACOGEORGEJ BVABISAACS VACOJIMERD BVAASANTIAGO BVAMTAYLOR VACOGRAYE VACOMORFOS VACOPAGANW] },
      "BVASKREMBS" => { attorneys: %w[BVACSAMUELSON VACOTEMPLB VACOSNYDEM VACOALTENI VACOBILSTM BVAAFAGAN VACOPETTIN VACOSMITHJ5 VACOTIMMEP] },
      "BVASBUSH" => { attorneys: %w[VACOSTEPHV VACOBADACD VACOROUSEG VACOASANTR VACOMAHONS BVAJMARLEY BVAKQUANDER] },
      "BVASDREISS" => { attorneys: %w[VACOGILLEL VACOIJITIK VACOJONEST1 BVAJCASTILLO VACOJORDANJ BVAJKITLAS BVASREGAN BVACSAMUELSON BVATWESNER BVAMAWILSON] },
      "BVAMBLACK" => { attorneys: %w[BVACKAMMEL VACOBARDIA VACOWANGQ BVAJDWORKIN VACOOREILD BVATBERRYMAN VACODAVIDC BVASECKERMA VACOFRANKM2 VACOSIMSR VACOYEHN] },
      "BVABBCOPELD" => { attorneys: %w[VACOIMAMS VACOCRAWFJ2 BVAJDWORKIN BVADSEATON BVATHSMITH VACOWAINAS] },
      "BVACFLEMING" => { attorneys: %w[VACOKINGC1 VACOSTUEDA BVAAMCLARK VACOCOMNIG BVALCONNOR VACOJIGGET VACOKATZD3 VACONEALM VACOTHOMPM6] },
      "BVASHENEKS" => { attorneys: %w[BVAJCHENG VACOONYEOO BVADBREDEHORS BVADBROOK BVANKAMAL BVACLAMB VACONOHP VACOWIMBIA] },
      "BVAMHERMAN" => { attorneys: %w[VACOMAHMOM BVAJFLYNN VACOMEINEK VACOGOREHA VACOALHINM BVAJBURRO BVATDOUGLAS VACOHUMPHD VACOLEEM2 VACOREKOWE VACOSAINDP] },
      "BVAAISHIZ" => { attorneys: %w[VACOGRIFFA VACOALEXAJ10 BVADMCASULA BVAKCHURCH BVAKFLETCHER BVAJPGERVAS VACOJOHNSS3 VACOMETZNP VACOSHAHN1 VACOVEMULR] },
      "BVAKKORDICH" => { attorneys: %w[VACOMAHMOM BVATSADAMS VACOANS BVAACRYAN VACOHOULED BVAJKIM VACOMOORET10 BVAMSOPKO VACOWINKLT BVAFFULLER] },
      "BVAKMILLIKAN" => { attorneys: %w[VACOMARTIS5 VACOBRUTOC BVASGINSKI BVADSNELSON VACONGUYEP BVACSMITH BVAHYOO] },
      "BVATOSHAY" => { attorneys: %w[VACOIMAMS BVATBERRYMAN BVAMMAC VACOTROWET BVASFLOT BVAJRBRYANT BVACLKRAS BVAKMITCHELL VACOPEDENN VACOHITED] },
      ...
      "BVALBARNARD" => { attorneys: %w[VACOBOGNAS VACOHARTFM BVAJMOATS BVAAMADDOX BVAAZENZANO BVAJUNGER VACOSUHG VACOLEEJ5 VACOZIMMEM VACOWHITLJ] },
      "BVAMAUER" => { attorneys: %w[VACOPURCEA VACOKIME2 VACOMIDDLJ BVAAAHLBERG BVASBOEHM BVASKIM BVAAPURCELL VACOGASTOK VACODAVIST1 VACOSHANNT] },
      "BVAMKILCOYN" => { attorneys: %w[VACOZIZZIA VACOJAIGIB BVAAADAMSON BVARDODD BVACBATES BVAPHOGAN VACOCARROE VACOJENSER VACOELLIOR VACOULLERJ] },
      "BVARFEINBERG" => { attorneys: %w[VACOLHERAD VACOSTLAUA VACOFOURNS BVAMOSBORNE BVAATURNIP BVAJOLSEN BVAJWILLIAMS VACODAUSH VACOWARREI VACOHITCHI] },
      "BVATASMITH" => { attorneys: %w[VACOLEEC1 VACOOHLSTD VACOROBERJ6 BVALEDWARDS BVAMHANNAN BVAEJALLEY VACOJAMISE VACOTAYLOC VACOPALACA VACORUIZR] },
      "BVAVCHIAPP" => { attorneys: %w[VACOOBODON VACOMASKB VACOSEBSTD BVALCROHE BVADEBAUGH BVAJSPRINGER VACOJOHNSP2 VACOWILLIL12 VACOGIAQUM] },
      "BVAHSCHARTZ" => { attorneys: %w[VACOGARLIC VACOMCDERK VACOSTRIKS BVANRIPPEL BVAASYED BVAMSUFFOLE BVARSTEPHENS VACOYOFFEP VACOSHANNG VACOCREEGA] },
      "BVAJFRANCIS" => { attorneys: %w[VACODICKET VACOSELLES	VACONESMIC VACODICKET BVACHOUBECK BVAJSCHROADER BVASHOOPEN BVAKKARDIAN VACOFITZGT VACOHARNEC1] },
      "BVADHACHEY" => { attorneys: %w[VACOBALLID VACOZHENGA3 VACOLJBAKKE BVADLEE BVASDELHAUER VACOMINEE VACOSCHICS VACOBRANDK1 VACOSALAZM] },
      "BVAMLANE" => { attorneys: %w[VACOYANGJ1 VACOHEBERM VACOKIMJ5 BVAJTAYLOR BVADTCHERRY BVAJDEFRANK VACODUFFYM VACOHENRYT VACOKEOGHN] },
      ...
      "BVAMAPAPPAS" => { attorneys: %w[VACOLITTLC VACOMULRAG BVALBCRYAN BVAAMICHEL VACOBASKEL BVAJTUNIS VACOBODIB VACOSETTEJ VACOKEELEB VACOWATSOM3] },
      ...
      "BVAGWASIK" => { attorneys: %w[VACOMASSEJ VACOSMITHR6 VACORONQUE BVAREPJONES BVACMCENTEE BVASNAJARIAN BVAMLUNGER VACOPRINSS VACOWADEJ] },
      "BVAESLEBOFF" => { attorneys: %w[VACOMYERSP VACOGLENNR VACOSHELTA BVACECKART BVACHANDY BVAMKREINDLER BVAMPREM BVAWSNYDER VACOHURLES VACOGRIFFJ] },
      "BVAPSORISIO" => { attorneys: %w[VACOWATKIM VACOMACCHP VACOHAND BVAJPRICHRD BVAPLOPEZ VACOSHOUMM VACOWILLIA5 VACOCRUZK VACOGELBEJ VACOMORALG] },
      "BVAJHAGER" => { attorneys: %w[VACOWALKER VACOSARACL VACOLOPEZA BVACDALE BVABELWOOD BVAACASTILLO BVALLEIFERT VACOMADDOR1 VACOLAROCN VACOCUMMIJ] },
      "BVAJMONROE" => { attorneys: %w[VACOWELLSW1 BVAKNEILSON BVAMSANFORD BVAMWILSON BVASCAMPBELL BVAJROTH VACORASULH VACOGANNOC] },
      "BVAJREINHART" => { attorneys: %w[VACOGARVEN VACOWILLII VACOLEUNGD BVAMPETERS BVASSTVIL BVASKEYVAN BVABCLEARY BVACSPEARS BVAABAKER VACOLABIA VACOPATRICN] },
      "BVAMHYLAND" => { attorneys: %w[VACOARIASM BVAMHARRIGAN BVABBERRY BVALKYLE BVASGORDON VACOJOSEYK VACOREEDB1 VACOCELTNJ VACOPITMAD] },
      "BVABKNOPE" => { attorneys: %w[VACOMCGEEI VACOPAGEA BVAABORDEWYK BVADORFANO BVAMPRYCE VACOMEYERJ2 VACOBORMAA VACOMASKAZ VACOVAMPLE VACOCROSNM] },
      "BVAKBCONNER" => { attorneys: %w[VACOCELLIL1 VACORUDDYM VACOKUKSOK VACOSEEHUS VACOBEHLER BVAKBUCKLEY BVACHERJONES VACOKLEPOK BVALKSTRAUSS VACOWALKER VACOYUNH] },
      "BVAASPECTOR" => { attorneys: %w[VACOIGLESM VACOLANTOF] },
      "BVAMDONOHUE" => { attorneys: %w[VACOMURPHE5 VACOMAKONM VACOAHSANN VACOJONEST] },
      "BVAKZADORA" => { attorneys: %w[VACOPIERCA1] },
      "BVALBCRYAN" => { attorneys: %w[BVABBERRY VACOKUKSOK VACOLABIA VACOLAROCN VACOMACCHP BVADORFANO VACOSHELTA] },
      "BVAEDEICHERT" => { attorneys: %w[VACOMOUZAJ] },
      "BVACASKOW" => { attorneys: %w[BVAEANDERSON BVAHABEACH VACOMACEKM VACOCOXT2 VACOEDWARC VACOFLYNNG VACOMUCKLP VACOGRIFFA1] },
      "BVAWDONNELLY" => { attorneys: %w[BVAMLUNGER BVAMSUFFOLE VACOBAXTES VACOKOMINB VACOLJBAKKE VACOMCDERK VACOONGG ] }
    }
  }.freeze

...
module Constants::AttorneyJudgeTeams
  ...
  JUDGES = {
    ...
    prod: {
      ...
      "BVALREIN" => { attorneys: %w[VACOROBINC6 VACOMAHAFC VACOPITTSA VACOPARRIA BVAJSHAW VACOBARBEM2 VACOCOOGAJ VACODELLAA BVASFINN BVACRYAN VACOKOE] },
      ...
      "BVAEVPAREDEZ" => { attorneys: %w[VACOKERNEI VACOJAVEDT VACOBAROND BVAKWALLIN VACOFOSTEK5 VACOSANDLJ VACOARNOLA2 VACOROEA] },
      ...
      "BVAMBLACK" => { attorneys: %w[VACOWANGQ BVAJDWORKIN VACOOREILD BVATBERRYMAN VACODAVIDC BVASECKERMA VACOFRANKM2 VACOSIMSR VACOYEHN] },
      ...
      "BVASHENEKS" => { attorneys: %w[VACOONYEOO BVADBREDEHORS BVADBROOK BVANKAMAL BVACLAMB VACONOHP VACOWIMBIA] },
      ...
      "BVATOSHAY" => { attorneys: %w[VACOTROWET VACOBARDIA BVASFLOT BVAJRBRYANT BVAJCHENG BVAJFLYNN VACOKALOLS BVACLKRAS BVAKMITCHELL VACOPEDENN VACOHITED BVACKAMMEL] },
      ...
      "BVAVCHIAPP" => { attorneys: %w[VACOOBODON VACOMASKB VACOSEBSTD VACODUPRED BVALCROHE BVADEBAUGH BVAJSPRINGER VACOJOHNSP2 VACOWILLIL12 VACOGIAQUM] },
      ...
      "BVALBCRYAN" => { attorneys: %w[BVABERRY VACOKUSOK VACOLABIA VACOLAROCN VACOMACCHP BVADORFANO VACOSHELTA] },

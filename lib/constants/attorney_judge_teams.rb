...
module Constants::AttorneyJudgeTeams
  ...
  JUDGES = {
    ...
    prod: {
      ...
      "VACOWHITEY" => { attorneys: %w[VACOGLAESJ VACOMURPHE5 VACOGLAESJ VACOABDELD BVAABARNER BVATSYKES VACOCHOC BVAALECH VACOLILLYG BVAMMOORE BVAPOLSON] },
      ...
      "BVAJHWA" => { attorneys: %w[BVASSLEEMI VACOMUCKLP VACOMUZZAR VACONEGROJ VACOFORDC BVAKPARKE VACOFREEMJ2 BVACCYKOWSKI VACOBUSHL2 VACOCASEYC] },
      ...
      "BVAURPOWELL" => { attorneys: %w[VACOKUTROA VACOLEARYS BVAABUDD BVAAFLAMINI BVAJHENRIQUEZ BVAMESPINOZA VACOBAKERJH VACOLEMOIB] },
      ...
      "BVASBELCHER" => { attorneys: %w[VACOWAGNED2 VACOROSSS1 BVARCASADEI VACOFARREB2 VACOHARPET BVAJLEE VACOLOGANL1 BVAJNICHOLS BVAMTHOMAS VACOYAFFEA] },
      ...
      "BVAJPARKER" => { attorneys: %w[VACOMILLEE1 VACODYER VACOBEDFOA BVAEBLOWERS BVAPKINGERY VACOCHOIE1 BVACPALMER VACOMEEHAP VACOMOORES BVAATENNEY] },
      ...
      "BVAMAUER" => { attorneys: %w[VACOKIME1 VACOMIDDLJ BVAAAHLBERG BVASBOEHM BVASKIM BVAAPURCELL VACOGASTOK VACODAVIST1 VACOSHANNT] },
      ...
      "BVAVCHIAPP" => { attorneys: %w[VACOMASKB VACOSEBSTD VACODUPRED BVALCROHE BVADEBAUGH BVAJSPRINGER VACOJOHNSP2 VACOWILLIL12 VACOGIAQUM] },
      ...
      "BVAJFRANCIS" => { attorneys: %w[VACONESMIC VACODICKET BVACHOUBECK BVAJSCHROADER BVASHOOPEN BVAKKARDIAN VACOFITZGT VACOONGG VACOHARNEC1] },
      "BVADHACHEY" => { attorneys: %w[VACOZHENGA3 BVACASKOW VACOLJBAKKE BVADLEE BVASDELHAUER VACOMINEE VACOSCHICS VACOBRANDK1 VACOSALAZM] },
      ...
      "BVAJREINHART" => { attorneys: %w[VACOWILLII VACOLEUNGD BVAMPETERS BVASSTVIL BVASKEYVAN BVABCLEARY BVACSPEARS BVAABAKER VACOLABIA VACOPATRICN] },
      ...
      "BVAKBCONNER" => { attorneys: %w[VACORUDDYM VACOKUKSOK VACOSEEHUS VACOBEHLER BVAKBUCKLEY BVACHERJONES VACOKLEPOK BVALKSTRAUSS VACOWALKER VACOYUNH] },

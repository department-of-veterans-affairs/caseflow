...
module Constants::AttorneyJudgeTeams
  ...
  JUDGES = {
    ...
    prod: {
      ...
      "BVADBROWN" => { attorneys: %w[VACOVOIGHB VACOFERRAC BVAMCARSTEN BVAHABEACH BVAMRUDE VACOMONTAJ VACOBAMETP VACOBOOKET VACOKERPAA] },
      ...
      "BVAMDONOHUE" => { attorneys: %w[VACOAHSANN VACOJONEST] }
    }
  }.freeze

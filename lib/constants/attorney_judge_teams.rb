...
module Constants::AttorneyJudgeTeams
  ...
  JUDGES = {
    ...
    prod: {
      ...
      "VACOWHITEY" => { attorneys: %w[VACOMURPHE5 VACOGLAESJ VACOABDELD BVAABARNER BVATSYKES VACOCHOC BVAALECH VACOLILLYG VACOZHURAM BVAMMOORE BVAPOLSON] },
      ...
      "BVABMULLINS" => { attorneys: %w[VACOTEICHC BVASCHINNERER BVAPVERESINK BVAANOLLEY VACOKUTROA VACOLEEY1 VACOFISHEH VACOWHITAN VACOTROTTR VACOKINGT10] },
      ...
      "BVAAJAEGER" => { attorneys: %w[VACOALMOSR VACOALSTOT VACOGAYEE VACOBROOKB4 BVAMOLSON VACOCLARKK1 VACOESTESJ VACOSTANTK] },
      ...
      "BVASKREMBS" => { attorneys: %w[VACOTEMPLB VACOSNYDEM VACOALTENI VACOBILSTM BVAAFAGAN VACOPETTIN VACOSMITHJ5 VACOTIMMEP] },
      ...
      "BVAMBLACK" => { attorneys: %w[VACOOREILD BVATBERRYMAN VACODAVIDC BVASECKERMA VACOFRANKM2 VACOSIMSR VACOYEHN] },
      ...
      "BVAAISHIZ" => { attorneys: %w[VACOGRIFFA1 VACOALEXAJ10 BVADMCASULA BVAKCHURCH BVAKFLETCHER BVAJPGERVAS VACOJOHNSS3 VACOMETZNP VACOSHAHN1 VACOVEMULR] },
      ...
      "BVAMLANE" => { attorneys: %w[VACOYANGJ1 VACOHEBERM VACOKIMJ5 BVAJTAYLOR BVADTCHERRY BVAJDEFRANK BVAAVANVALK VACODUFFYM VACOHENRYT VACOMORRAS1 VACOKEOGHN] },
      ...
      "BVAGWASIK" => { attorneys: %w[VACOMASSEJ VACOSMITHR6 VACORONQUE BVAREPJONES BVACMCENTEE BVASNAJARIAN BVAMLUNGER VACOTISSEJ VACOPRINSS VACOWADEJ] },

...
module Constants::AttorneyJudgeTeams
  ...
  JUDGES = {
    ...
    prod: {
      ...
      "BVALJENG" => { attorneys: %w[VACOVAUGHT VACOJONEST VACOMAKONM BVAAALDERMAN BVAMJIN BVADSCHECHT VACORAFTEG VACOINNETL] },
      ...
      "BVARKESSEL" => { attorneys: %w[VACOBECTOS BVACBOSELY VACOGEORGEJ BVABISAACS VACOJIMERD BVAMTAYLOR VACOGRAYE VACOMORFOS VACOPAGANW] },
      ...
      "BVAJFRANCIS" => { attorneys: %w[VACOSELLES	VACONESMIC BVACHOUBECK BVAJSCHROADER BVASHOOPEN BVAKKARDIAN VACOFITZGT VACOHARNEC1] },
      "BVADHACHEY" => { attorneys: %w[BVAJBARONE VACOBALLID VACOZHENGA3 BVADLEE BVASDELHAUER VACOMINEE VACOSCHICS VACOSALAZM] },
      ...
      "BVAPSORISIO" => { attorneys: %w[VACOWATKIM VACOHAND BVAJPRICHRD BVAPLOPEZ VACOWILLIA5 VACOCRUZK VACOGELBEJ VACOMORALG] },
      ...
      "BVAMDONOHUE" => { attorneys: %w[BVAATURNIP VACOSUHG VACODECHIA VACODAVIST1 VACOZIZZIA VACOSEBSTD VACOLHERAD VACOMORRAS] },
      ...
      "BVAWDONNELLY" => { attorneys: %w[VACOHARNEC1 BVAMLUNGER BVAMSUFFOLE VACOBAXTES VACOLJBAKKE VACOMCDERK VACOONGG] }
    }
  }.freeze

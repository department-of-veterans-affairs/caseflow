...
module Constants::AttorneyJudgeTeams
  ...
  JUDGES = {
    ...
    prod: {
      ...
      "BVAPMLYNCH" => { attorneys: %w[VACOHAASJ BVAJRUTKIN BVALMCCABE BVANSANGSTER BVAMPURDUM VACOSTEDMM VACODENTOB VACOSINCKL VACOMUSSES2 VACOEDWARC] },
      ...
      "BVATKONYA" => { attorneys: %w[VACOROBERD1 VACOGRESHT BVASPFLUGNER BVANMCELWAIN BVAAHAMPTON BVAGFRASER VACOFERGUA VACONELSOL3 VACOWINBUB VACOMARTIC9] },
      ...
      "BVAAJAEGER" => { attorneys: %w[VACOALMOSR VACOALSTOT VACOGAYEE VACOBROOKB4 BVAMOLSON VACOCLARKK1 VACOESTESJ VACOHTUNL BVAAPANIO BVAKSOSNA VACOSTANTK] },
      ...
      "BVAMHERMAN" => { attorneys: %w[VACOGOREHA VACOALHINM BVAJBURRO BVATDOUGLAS VACOGRZECT VACOHUMPHD VACOLEEM2 BVAMMAC VACOREKOWE VACOSAINDP] },
      ...
      "BVATASMITH" => { attorneys: %w[VACOOHLSTD VACOROBERJ6 BVALEDWARDS BVAMHANNAN BVAEJALLEY VACOJAMISE VACOTAYLOC VACOPALACA VACORUIZR] },
      ...
      "BVAJHAGER" => { attorneys: %w[VACOSARACL VACOLOPEZA BVACDALE BVABELWOOD BVAACASTILLO BVALLEIFERT VACOMADDOR1 VACOLAROCN VACOCUMMIJ] },
      ...
      "BVAKBCONNER" => { attorneys: %w[VACORUDDYM VACOKUKSOK VACOSEEHUS VACOBEHLER BVAKBUCKLEY VACOFAVERA BVACHERJONES VACOKLEPOK BVALKSTRAUSS VACOWALKER VACOYUNH BVAKCHANCE] },

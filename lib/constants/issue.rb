...
# These diagnostic code descriptions are for vets/Status users and are
# intentionally different than constants/STAFF_DIAGNOSTIC_CODE_DESCRIPTIONS.json,
# which are for board staff users. TODO: Fetch and cache descriptions from VACOLS
module Constants::Issue
  STATUS_DIAGNOSTIC_CODE_DESCRIPTIONS = {
    "5000" => "osteomyelitis",

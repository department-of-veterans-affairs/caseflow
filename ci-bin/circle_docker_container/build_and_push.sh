...
docker tag circleci 008577686731.dkr.ecr.us-gov-west-1.amazonaws.com/circleci:edge-latest
if docker push 008577686731.dkr.ecr.us-gov-west-1.amazonaws.com/circleci:edge-latest ; then

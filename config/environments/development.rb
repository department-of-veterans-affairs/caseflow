Rails.application.configure do
  ...
  #
  # Additionally, Spring (when in use) reloads application code, and therefore needs the application to have
  # reloading enabled (`config.cache_classes == false`) for environments that Spring manages.

...
if DatabaseRequestCounter.valid_env?
  ...
  def simulate_vacols_latency
    ...
    # Default determined from metrics sent to Datadog: # review with Noelle
    # https://app.datadoghq.com/dashboard/54w-efy-r5d/va-systems?fullscreen_widget=399796003 # review with Noelle

...
prior_examination_inadequate = [
  ...
  "Service Records Not Considered", "Johnson (2018)", "Correia", "Ray", "Clemons", "Sharp", "Chavis", "Miller",
  "English", "Francway", "Rice", "Lyles", "Robinson", "Swain", "Chotta", "McLendon", "Barr", "Reonal", "Bailey",
  "Mitchell", "Bankhead", "Jones (2012)", "Quinn", "Buchanan", "Deluca", "El-Amin", "Saunders", "Floore",
  "Nieves-Rodriguez", "Smith", "Withers", "Stefl", "Delrio", "Fountain", "DeLisio", "Mauerhan", "Monzingo", "Tucker",
  "Caluza", "Buie", "Bradley", "Thun", "Harper", "Tatum", "Hart", "Walsh", "Buczynski", "Wise", "Cook", "Hensley",
  "Snider", "Stegall", "Overton", "Atencio", "Stewart", "DelaCruz", "AB", "Dalton", "Wagner", "McGrath", "Garner",
  "King", "Pierce", "Cullen", "Cantrell", "Bryant", "O'Hare", "McCray", "Vazquez-Claudio", "Allday", "Geib", "Kahana",
  "Burton", "Stankevich", "Smiddy", "Horn", "Svehla", "Jandreau", "Schafrath", "Combee", "Esteban", "McKinney",
  "Euzebio", "Washington", "Frost", "Pernorio", "Ward", "Dennis", "Ortiz-Valles", "Wages", "Ardison", "Dofflemyer",
  "McClain", "Savage", "Gutierrez", "Walker", "McNair", "Roberson", "Caffrey", "Russo", "Hall", "Shade", "Bardwell",
  "Long", "Polovick", "Comer", "McCarroll", "Healey", "Gleicher", "Palczewski", "Beraud", "Boggs", "Brokowski",
  "Brown", "Sprinkle", "Molitor", "Buckley", "Reeves", "Golden", "Daves", "Gilbert", "Moore", "Southall-Norman",
  "Cosman", "Jarrell", "Lang", "Arline", "Delisle", "Bond", "Percy", "Henderson", "Medrano", "McDowell", "Ephraim",
  "Gazelle", "Beaty", "Acree", "Fagan", "KisorIII", "Gaston", "Alpough", "Blubaugh", "Ortiz", "Fenderson", "Kuzma",
  "Friscia", "Helmick", "Colvin", "Langdon", "Golz", "Payne", "Eubzebio", "Layno", "Suttman", "Acevedo", "Tedesco",
  "Allen", "Akles", "Manlicon", "Cogburn", "Pratt", "Nehmer", "Manlincon", "Espiritu", "Quirin", "Snuffer", "Martin",
  "Sowers", "Hickson", "Joyner", "McCarrol", "Mittleider", "Dyment", "Sullivan", "Holmes", "Mittlleider", "Harris",
  "Justus", "Romero", "Thompson", "Todd", "Beyrle", "Vaquez-Claudio", "Hudgens", "Disabled Am. Veterans", "Biestek",
  "Morgan", "Geibce", "Khana", "McLain", "Waters", "Sizemore", "Hatlestad", "Murray", "Myers", "Karnas", "Other"
]
...
prior_opinion_inadequate = [
  ...
  "Reonal", "Johnson (2018)", "Ray", "Sharp", "Chavis", "Miller", "English", "Bailey", "Clemons", "Lyles", "Francway",
  ...
  "Dennis", "Ortiz-Valles", "Wages", "Ardison", "Dofflemyer", "McClain", "Savage", "Gutierrez", "Walker", "McNair",
  "Roberson", "Caffrey", "Russo", "Hall", "Shade", "Bardwell", "Long", "Polovick", "Comer", "McCarroll", "Healey",
  "Gleicher", "Palczewski", "Beraud", "Boggs", "Brokowski", "Brown", "Sprinkle", "Molitor", "Buckley", "Reeves",
  "Golden", "Daves", "Gilbert", "Moore", "Southall-Norman", "Cosman", "Jarrell", "Lang", "Arline", "Delisle", "Bond",
  "Percy", "Henderson", "Medrano", "McDowell", "Ephraim", "Gazelle", "Beaty", "Acree", "Fagan", "KisorIII", "Gaston",
  "Alpough", "Blubaugh", "Ortiz", "Fenderson", "Kuzma", "Friscia", "Helmick", "Colvin", "Langdon", "Golz", "Payne",
  "Eubzebio", "Layno", "Suttman", "Acevedo", "Tedesco", "Allen", "Akles", "Manlicon", "Cogburn", "Pratt", "Nehmer",
  "Manlincon", "Espiritu", "Quirin", "Snuffer", "Martin", "Sowers", "Hickson", "Joyner", "McCarrol", "Mittleider",
  "Dyment", "Sullivan", "Holmes", "Mittlleider", "Harris", "Justus", "Romero", "Thompson", "Todd", "Beyrle",
  "Vaquez-Claudio", "Hudgens", "Disabled Am. Veterans", "Biestek", "Morgan", "Geibce", "Khana", "McLain", "Waters",
  "Sizemore", "Hatlestad", "Murray", "Myers", "Karnas", "Other"
]

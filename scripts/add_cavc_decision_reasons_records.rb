...
# bundle exec rails runner scripts/add_cavc_decision_reasons_records.rb

# run this after migration create_cavc_decision_reasons to add the required records to the DB

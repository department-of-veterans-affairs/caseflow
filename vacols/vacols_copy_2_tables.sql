  ...
  PCTFREE 10 PCTUSED 90 INITRANS 1 MAXTRANS 255
 NOCOMPRESS LOGGING
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "VACOLS"."INPUT_TABLE"
   (	"ITRPT" VARCHAR2(16),
	"ITSTART" DATE,
	"ITEND" DATE,
	"ITCOUNT" NUMBER(6,0),
 ...
 NOCOMPRESS LOGGING
  ...
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "VACOLS_TABLES"  ENABLE,
	 SUPPLEMENTAL LOG DATA (ALL) COLUMNS
   ) SEGMENT CREATION IMMEDIATE
  PCTFREE 10 PCTUSED 90 INITRANS 1 MAXTRANS 255
 NOCOMPRESS LOGGING
 ...
 NOCOMPRESS LOGGING
  ...
  PCTFREE 30 PCTUSED 70 INITRANS 1 MAXTRANS 255
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 1207959552 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "VACOLS_PRIORLOC" ;


  CREATE TABLE "VACOLS"."OTHDOCS"
   (	"TICKNUM" VARCHAR2(12),
	"CLMFLD" VARCHAR2(3),
	"INCLMFLD" VARCHAR2(3),
	"XRAY" VARCHAR2(3),
 ...
 NOCOMPRESS LOGGING
  ...
  PCTFREE 10 PCTUSED 90 INITRANS 1 MAXTRANS 255
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 394264576 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "VACOLS_ISSUES" ;


  CREATE TABLE "VACOLS"."TBSCHED"
   (	"TBYEAR" VARCHAR2(4),
	"TBTRIP" NUMBER(4,0),
	"TBLEG" NUMBER(1,0),
	"TBRO" VARCHAR2(16),
  ...
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "VACOLS_HEARSCHED"  ENABLE,
	 SUPPLEMENTAL LOG DATA (ALL) COLUMNS
   ) SEGMENT CREATION IMMEDIATE
  PCTFREE 10 PCTUSED 90 INITRANS 1 MAXTRANS 255
 NOCOMPRESS LOGGING
  ...
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "BVA_EMPLOYEE"  ENABLE,
	 SUPPLEMENTAL LOG DATA (ALL) COLUMNS
   ) SEGMENT CREATION IMMEDIATE
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255
 NOCOMPRESS LOGGING
 ...
 NOCOMPRESS LOGGING
  ...
  PCTFREE 30 PCTUSED 70 INITRANS 1 MAXTRANS 255
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 528482304 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "VACOLS_FOLDER" ;


  CREATE TABLE "VACOLS"."DECASS"
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "VACOLS"."MVR_BROKER_NOD"
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "VACOLS"."MVR_BROKER_TO_BVA_Q"
 ...
 NOCOMPRESS LOGGING
  ...
  PCTFREE 30 PCTUSED 70 INITRANS 1 MAXTRANS 255
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 419430400 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "VACOLS_CORRES" ;


  CREATE TABLE "VACOLS"."BRIEFF"
   (	"BFKEY" VARCHAR2(12),
	"BFDDEC" DATE,
  ...
  PCTFREE 30 PCTUSED 70 INITRANS 1 MAXTRANS 255
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 620756992 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "VACOLS_BRIEFF" ;


  CREATE TABLE "VACOLS"."DEVHIS"
   (	"DHKEY" VARCHAR2(12),
	"DHDDVIN" DATE,
	"DHDDVOUT" DATE,
	"DHDDVWRK" DATE,
 ...
 NOCOMPRESS LOGGING
  ...
  PCTFREE 10 PCTUSED 90 INITRANS 1 MAXTRANS 255
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 570425344 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "VACOLS_ATTACH" ;


  CREATE TABLE "VACOLS"."ASSIGN"
   (	"TASKNUM" VARCHAR2(12),
	"TSKTKNM" VARCHAR2(12),
  ...
  PCTFREE 10 PCTUSED 90 INITRANS 1 MAXTRANS 255
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 1275068416 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "VACOLS_ASSIGN" ;


  CREATE TABLE "VACOLS"."EXCEPTION"
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "VACOLS"."MLOG$_ACTCODE"
   (	"M_ROW$$" VARCHAR2(255),
	"SNAPTIME$$" DATE,
	"DMLTYPE$$" VARCHAR2(1),
	"OLD_NEW$$" VARCHAR2(1),
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "VACOLS"."MLOG$_ASSIGN"
   (	"M_ROW$$" VARCHAR2(255),
	"SNAPTIME$$" DATE,
	"DMLTYPE$$" VARCHAR2(1),
	"OLD_NEW$$" VARCHAR2(1),
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "VACOLS"."MLOG$_ATTACH"
   (	"M_ROW$$" VARCHAR2(255),
	"SNAPTIME$$" DATE,
	"DMLTYPE$$" VARCHAR2(1),
	"OLD_NEW$$" VARCHAR2(1),
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "VACOLS"."MLOG$_BRIEFF"
   (	"M_ROW$$" VARCHAR2(18),
	"SNAPTIME$$" DATE,
	"DMLTYPE$$" VARCHAR2(1),
	"OLD_NEW$$" VARCHAR2(1),
  ...
  PCTFREE 5 PCTUSED 30 INITRANS 1 MAXTRANS 255
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "VACOLS"."MLOG$_COIN"
   (	"M_ROW$$" VARCHAR2(255),
	"SNAPTIME$$" DATE,
	"DMLTYPE$$" VARCHAR2(1),
	"OLD_NEW$$" VARCHAR2(1),
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "VACOLS"."MLOG$_CORRES"
   (	"M_ROW$$" VARCHAR2(18),
	"SNAPTIME$$" DATE,
	"DMLTYPE$$" VARCHAR2(1),
	"OLD_NEW$$" VARCHAR2(1),
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "VACOLS"."MLOG$_CORRTYPS"
   (	"M_ROW$$" VARCHAR2(18),
	"SNAPTIME$$" DATE,
	"DMLTYPE$$" VARCHAR2(1),
	"OLD_NEW$$" VARCHAR2(1),
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "VACOLS"."MLOG$_COVA"
   (	"M_ROW$$" VARCHAR2(255),
	"SNAPTIME$$" DATE,
	"DMLTYPE$$" VARCHAR2(1),
	"OLD_NEW$$" VARCHAR2(1),
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "VACOLS"."MLOG$_FOLDER"
   (	"M_ROW$$" VARCHAR2(18),
	"SNAPTIME$$" DATE,
	"DMLTYPE$$" VARCHAR2(1),
	"OLD_NEW$$" VARCHAR2(1),
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "VACOLS"."MLOG$_HEARSCHED"
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "VACOLS"."MLOG$_ISSREF"
   (	"M_ROW$$" VARCHAR2(18),
	"SNAPTIME$$" DATE,
	"DMLTYPE$$" VARCHAR2(1),
	"OLD_NEW$$" VARCHAR2(1),
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "VACOLS"."MLOG$_ISSUES"
   (	"M_ROW$$" VARCHAR2(18),
	"SNAPTIME$$" DATE,
	"DMLTYPE$$" VARCHAR2(1),
	"OLD_NEW$$" VARCHAR2(1),
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "VACOLS"."MLOG$_MAIL"
   (	"M_ROW$$" VARCHAR2(255),
	"SNAPTIME$$" DATE,
	"DMLTYPE$$" VARCHAR2(1),
	"OLD_NEW$$" VARCHAR2(1),
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "VACOLS"."MLOG$_PRIORLOC"
   (	"M_ROW$$" VARCHAR2(255),
	"SNAPTIME$$" DATE,
	"DMLTYPE$$" VARCHAR2(1),
	"OLD_NEW$$" VARCHAR2(1),
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "VACOLS"."MLOG$_RMDREA"
   (	"M_ROW$$" VARCHAR2(255),
	"SNAPTIME$$" DATE,
	"DMLTYPE$$" VARCHAR2(1),
	"OLD_NEW$$" VARCHAR2(1),
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "VACOLS"."MLOG$_STAFF"
   (	"M_ROW$$" VARCHAR2(255),
	"SNAPTIME$$" DATE,
	"DMLTYPE$$" VARCHAR2(1),
	"OLD_NEW$$" VARCHAR2(1),
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "VACOLS"."MLOG$_VFTYPES"
   (	"M_ROW$$" VARCHAR2(255),
	"SNAPTIME$$" DATE,
	"DMLTYPE$$" VARCHAR2(1),
	"OLD_NEW$$" VARCHAR2(1),
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE GLOBAL TEMPORARY TABLE "VACOLS"."RUPD$_REP"
   (	"REPKEY" VARCHAR2(12),
	"REPADDTIME" DATE,
	"DMLTYPE$$" VARCHAR2(1),
	"SNAPID" NUMBER(*,0),

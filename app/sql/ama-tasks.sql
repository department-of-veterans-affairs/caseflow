SELECT "Tasks"."id" AS "id"
  ...
  ,CAST("Tasks"."status" AS TEXT) AS "status"
  ,CAST("Tasks"."type" AS TEXT) AS "type"
  ,CAST("Tasks"."instructions" AS TEXT) AS "instructions"
  ...
  ,CAST("Tasks"."appeal_type" AS TEXT) AS "appeal_type"
  ,"Tasks"."placed_on_hold_at" AS "placed_on_hold_at"
  ,"Tasks"."on_hold_duration" AS "on_hold_duration"
  ,CAST("Tasks"."assigned_to_type" AS TEXT) AS "assigned_to_type"
  ,"Tasks"."parent_id" AS "parent_id"
  ,"Tasks"."closed_at" AS "closed_at"
  ,"Assigned By User"."id" AS "id (users)"
  ,CAST("Assigned By User"."station_id" AS TEXT) AS "station_id"
  ,CAST("Assigned By User"."css_id" AS TEXT) AS "css_id"
  ,CAST("Assigned By User"."full_name" AS TEXT) AS "full_name"
  ,CAST("Assigned By User"."email" AS TEXT) AS "email"
  ,CAST("Assigned By User"."roles" AS TEXT) AS "roles"
  ,CAST("Assigned By User"."selected_regional_office" AS TEXT) AS "selected_regional_office"
  ...
  ,CAST("Assigned To User"."station_id" AS TEXT) AS "station_id (users)"
  ,CAST("Assigned To User"."css_id" AS TEXT) AS "css_id (users)"
  ,CAST("Assigned To User"."full_name" AS TEXT) AS "full_name (users)"
  ,CAST("Assigned To User"."email" AS TEXT) AS "email (users)"
  ,CAST("Assigned To User"."roles" AS TEXT) AS "roles (users)"
  ,CAST("Assigned To User"."selected_regional_office" AS TEXT) AS "selected_regional_office (users)"
  ...
  ,CAST("AMA Appeals"."docket_number" AS TEXT) AS "docket_number"
  ,"AMA Appeals"."id" AS "id (custom sql query)"
  ,CAST("AMA Appeals"."veteran_file_number" AS TEXT) AS "veteran_file_number"
  ,"AMA Appeals"."receipt_date" AS "receipt_date"
  ,CAST("AMA Appeals"."docket_type" AS TEXT) AS "docket_type"
  ...
  ,CAST("AMA Appeals"."establishment_error" AS TEXT) AS "establishment_error"
  ...
  ,CAST("AMA Appeals"."closest_regional_office" AS TEXT) AS "closest_regional_office (ama appeals)"
  ,"AMA Appeals"."establishment_canceled_at" AS "establishment_canceled_at"
  ,"AMA Appeals"."docket_range_date" AS "docket_range_date"
  ,CAST("AMA Appeals"."poa_participant_id" AS TEXT) AS "poa_participant_id"
  ,"AMA Appeals"."attorney_task_id" AS "attorney_task_id"
  ,CAST("AMA Appeals"."distribution_task_status" as TEXT) AS "distribution_task_status"
  ,CAST("AMA Appeals"."timed_hold_task_status" AS TEXT) AS "timed_hold_task_status"
  ,CAST("AMA Appeals"."judge_decision_review_task_status" AS TEXT) AS "judge_decision_review_task_status"
  ,CAST("AMA Appeals"."attorney_task_status" AS TEXT) AS "attorney_task_status"
  ,"AMA Appeals"."attorney_task_status_started_date" AS "attorney_task_status_started_date"
  ,CAST("AMA Appeals"."judge_task_status" AS TEXT) AS "judge_task_status"
  ,CAST("AMA Appeals"."quality_review_task_status" AS TEXT) AS "quality_review_task_status"
  ,CAST("AMA Appeals"."attorney_name" AS TEXT) AS "attorney_name"
  ,"AMA Appeals"."attorney_id" AS "attorney_id"
  ,"AMA Appeals"."judge_id" AS "judge_id"
  ,CAST("AMA Appeals"."judge_name" AS TEXT) AS "judge_name"
  ,CAST("AMA Appeals"."bva_dispatch_task_status" AS TEXT) AS "bva_dispatch_task_status"
  ...
  ,CAST("Veterans"."file_number" AS TEXT) AS "file_number"
  ,CAST("Veterans"."participant_id" AS TEXT) AS "participant_id"
  ,CAST("Veterans"."first_name" AS TEXT) AS "first_name"
  ,CAST("Veterans"."last_name" AS TEXT) AS "last_name"
  ,CAST("Veterans"."middle_name" AS TEXT) AS "middle_name"
  ,CAST("Veterans"."name_suffix" AS TEXT) AS "name_suffix"
  ,CAST("Veterans"."closest_regional_office" AS TEXT) AS "closest_regional_office"
  ,"Attorney"."id" AS "id (users) #2"
  ,CAST("Attorney"."station_id" AS TEXT) AS "station_id (users) #1"
  ,CAST("Attorney"."css_id" AS TEXT) AS "css_id (users) #1"
  ,CAST("Attorney"."full_name" AS TEXT) AS "full_name (users) #1"
  ,CAST("Attorney"."email" AS TEXT) AS "email (users) #1"
  ,CAST("Attorney"."roles" AS TEXT) AS "roles (users) #1"
  ,CAST("Attorney"."selected_regional_office" AS TEXT) AS "selected_regional_office (users) #1"
  ...
  ,CAST("Judge"."station_id" AS TEXT) AS "station_id (users) #2"
  ,CAST("Judge"."css_id" AS TEXT) AS "css_id (users) #2"
  ,CAST("Judge"."full_name" AS TEXT) AS "full_name (users) #2"
  ,CAST("Judge"."email" AS TEXT) AS "email (users) #2"
  ,CAST("Judge"."roles" AS TEXT) AS "roles (users) #2"
  ,CAST("Judge"."selected_regional_office" AS TEXT) AS "selected_regional_office (users) #2"
...
LEFT JOIN "public"."users" "Assigned By User" ON ("Tasks"."assigned_by_id" = "Assigned By User"."id")
LEFT JOIN "public"."users" "Assigned To User" ON ("Tasks"."assigned_to_id" = "Assigned To User"."id")
LEFT JOIN (
  WITH appeal_task_status AS (
      SELECT *
        ...
        ,(
          ...
          FROM tasks AS tasks
          WHERE tasks.appeal_id = appeals.id
            AND tasks.type IN ('AttorneyTask', 'AttorneyRewriteTask') limit 1
          ) AS attorney_task_id
        ,(
          SELECT tasks.STATUS
          FROM tasks AS tasks
        ...
        ,(
          ...
          ORDER BY tasks.closed_at DESC limit 1
        ...
        ,(
          ...
          FROM tasks AS tasks
          WHERE tasks.appeal_id = appeals.id
            AND tasks.type IN ('BvaDispatchTask', 'QualityReviewTask') limit 1
  ...
  ) "AMA Appeals" ON ("Tasks"."appeal_id" = "AMA Appeals"."id")
LEFT JOIN "public"."veterans" "Veterans" ON ("AMA Appeals"."veteran_file_number" = CAST("Veterans"."file_number" AS TEXT))
LEFT JOIN "public"."users" "Attorney" ON ("AMA Appeals"."attorney_id" = CAST("Attorney"."id" AS TEXT))
LEFT JOIN "public"."users" "Judge" ON ("AMA Appeals"."judge_id" = CAST("Judge"."id" AS TEXT))
LEFT JOIN claimants AS cl ON cl.decision_review_id = "AMA Appeals"."id"
  AND cl.decision_review_type = 'Appeal'
LEFT JOIN people AS pe ON pe.participant_id = cl.participant_id
LEFT JOIN advance_on_docket_motions AS aod ON aod.person_id = pe.id

    ...
    when :too_many_unassigned_cases
      {
        ...
        "detail": "Please ensure you have #{CaseDistributionLever.find_by_item(Constants.DISTRIBUTION.request_more_cases_minimum).value.humanize} or fewer unassigned cases before requesting more."
      }

...
class MembershipRequestsController < ApplicationController
  def create
    ...
    program_office_access = allowed_params[:programOfficesAccess]
    ...
    # new_request = MembershipRequest.new(organization: VhaCamo.singleton, requestor: current_user, note: request_reason)

...
class HearingUpdateForm < BaseHearingUpdateForm
  ...
  def update_hearing
    ...
    update_advance_on_docket_motion if advance_on_docket_motion_attributes[:granted].presence
  end
  ...
  def update_advance_on_docket_motion
    AdvanceOnDocketMotion.create_or_update_by_appeal(hearing.appeal, advance_on_docket_motion_attributes)
  end

...
class CorrespondenceRelation < ApplicationRecord
  ...
  validates :column, presence: :related_correspondence_id
  validates :column, numericality: :correspondence_id
  validates :column, numericality: :related_correspondence_id

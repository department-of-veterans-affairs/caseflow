...
class DecisionDocument < CaseflowRecord
  ...
  def process!
    ...
    if appeal.is_a?(Appeal)
      ...
      # We do not want to process Board Grant Effectuations or create remand supplemental claims for appeals with unrecognized appellants because claim establishment

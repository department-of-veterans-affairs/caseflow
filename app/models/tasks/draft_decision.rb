class DraftDecision
  ...
  ATTRS = [:appeal_id, :user_id, :due_on, :assigned_on, :docket_name, :docket_date, :added_by_name, :added_by_css_id].freeze
  attr_accessor(*ATTRS)
  ...
  def self.from_vacols(case_assignment, user_id)
    new(
      ...
      added_by_css_id: case_assignment.added_by_css_id.present? ? case_assignment.added_by_css_id : "",

...
class VACOLS::CaseHearing < VACOLS::Record
  ...
  # @note The sequence for primary key `hearing_pkseq` is generated by a trigger defined on the VACOLS table
  # @see https://github.com/department-of-veterans-affairs/VACOLS/blob/0999c2b1e6d7561ab142d35f93c76a291aa7cce6/vacols_schema.sql#L5058-L5073
  #
  # @note Support for trigger-based primary keys is removed from `activerecord-oracle_enhanced-adapter` starting v6.0.Z:
  # @see https://github.com/rsim/oracle-enhanced/blob/81fbebec11f15fbc9724c6b36e98151fbd374b75/lib/active_record/connection_adapters/oracle_enhanced_adapter.rb#L452
  #
  # @note This is a workaround, which overrides `ActiveRecord::ModelSchema::ClassMethods #next_sequence_value` to always
  #   return `nil`, as it does on `activerecord-oracle_enhanced-adapter` before v6.0.Z:
  # @see https://github.com/rsim/oracle-enhanced/blob/95065589d4d49ea24eb79afc2883fc6180d97e67/lib/active_record/connection_adapters/oracle_enhanced_adapter.rb#L422

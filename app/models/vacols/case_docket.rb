...
class VACOLS::CaseDocket < VACOLS::Record
  ...
  left join (
      select BRIEFF.BFKEY, BRIEFF.BFCORLID, BRIEFF.BFDDEC, BRIEFF.BFMEMID as PREV_DECIDING_JUDGE, BRIEFF.BFAC as PREV_TYPE_ACTION, FOLDER.TINUM, FOLDER.TITRNUM
      from BRIEFF
      inner join FOLDER on FOLDER.TICKNUM = BRIEFF.BFKEY
  ...
  SELECT_PRIORITY_APPEALS = "
    select BFKEY, BFDLOOUT, VLJ, PREV_APPEAL.PREV_TYPE_ACTION, PREV_APPEAL.PREV_DECIDING_JUDGE
      from (
  ...
  SELECT_PRIORITY_APPEALS_ORDER_BY_BFD19 = "
    select BFKEY, BFD19, BFDLOOUT, VLJ, PREV_APPEAL.PREV_TYPE_ACTION, PREV_APPEAL.PREV_DECIDING_JUDGE
      from (
  ...
  SELECT_NONPRIORITY_APPEALS = "
    select BFKEY, BFDLOOUT, VLJ, DOCKET_INDEX, PREV_APPEAL.PREV_TYPE_ACTION, PREV_APPEAL.PREV_DECIDING_JUDGE
    from (
  ...
  SELECT_NONPRIORITY_APPEALS_ORDER_BY_BFD19 = "
    select BFKEY, BFD19, BFDLOOUT, VLJ, DOCKET_INDEX, PREV_APPEAL.PREV_TYPE_ACTION, PREV_APPEAL.PREV_DECIDING_JUDGE
    from (
  ...
  SELECT_READY_TO_DISTRIBUTE_APPEALS_ORDER_BY_BFD19 = "
    select APPEALS.BFKEY, APPEALS.TINUM, APPEALS.BFD19, APPEALS.BFDLOOUT, APPEALS.AOD, APPEALS.BFCORLID,
      ...
      case when APPEALS.BFAC = '7' then 1 else 0 end CAVC, PREV_APPEAL.PREV_TYPE_ACTION,
         PREV_APPEAL.PREV_DECIDING_JUDGE
    from (

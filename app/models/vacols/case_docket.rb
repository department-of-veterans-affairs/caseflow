...
class VACOLS::CaseDocket < VACOLS::Record
  ...
  SELECT_READY_APPEALS = "
    select BFKEY, BFD19, BFCORLID, BFDLOOUT, BFMPRO, BFCURLOC, BFAC, TINUM, TITRNUM, AOD,
    BFMEMID, BFDPDCN
    #{FROM_READY_APPEALS}
  "
  ...
  SELECT_READY_APPEALS_ADDITIONAL_COLS = "
    select BFKEY, BFD19, BFDLOOUT, BFMPRO, BFCURLOC, BFAC, TINUM, TITRNUM, AOD, BFMEMID, BFDPDCN,
    BFCORKEY, BFCORLID
    #{FROM_READY_APPEALS}
  "

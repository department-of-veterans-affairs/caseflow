  ...
  def post_decision
...

    {
      ...
      details:
      {
        ...
        cavcDueDate: appeal? ? (decision_review.decision_date_for_api_alert + CaseDistributionLever.find_by_item('appeal_status_cavc_due_date').try(:value).days) : nil
      }
    }
  end
    ...
    decision_review.remand_supplemental_claims.map do |remand_sc|
      {
        ...
        details:
        {
          ...
          cavcDueDate: remand_sc.decision_event_date + CaseDistributionLever.find_by_item('appeal_status_cavc_due_date').try(:value).days
        }
      }
    end
  end
  ...
  def post_effectuation
...

    {
      ...
      details:
      {
        ...
        cavcDueDate: decision_review.decision_effectuation_event_date + CaseDistributionLever.find_by_item('appeal_status_cavc_due_date').try(:value).days
      }
    }
  end

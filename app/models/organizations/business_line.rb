...
class BusinessLine < Organization
  ...
  COLUMN_NAMES = [
    ...
    Constants.QUEUE_CONFIG.DECISION_REVIEW_QUEUE_COLUMNS.CLAIMANT_NAME.name,
    Constants.QUEUE_CONFIG.DECISION_REVIEW_QUEUE_COLUMNS.VETERAN_SSN.name,
    Constants.QUEUE_CONFIG.DECISION_REVIEW_QUEUE_COLUMNS.ISSUE_COUNT.name,
    Constants.QUEUE_CONFIG.DECISION_REVIEW_QUEUE_COLUMNS.DAYS_WAITING.name,
    Constants.QUEUE_CONFIG.DECISION_REVIEW_QUEUE_COLUMNS.TASK_TYPE.name
  ].compact

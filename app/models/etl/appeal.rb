...
class ETL::Appeal < ETL::Record
  class << self
    ...
    def merge_original_attributes_to_target(original, target)
      ...
      aod = claimant.person.advance_on_docket_motions.last
      ...
      target.claimant_last_name = claimant.person.last_name
      target.claimant_name_suffix = claimant.person.name_suffix
      target.claimant_participant_id = claimant.participant_id
      target.claimant_payee_code = claimant.payee_code
      target.claimant_person_id = claimant.person.id

...
class DocketCoordinator
  ...
  def docket_proportions
    ...
    direct_review_proportion = [
      ...
      CaseDistributionLever.find_float_lever('maximum_direct_review_proportion')
    ].min
    ...
    if @docket_proportions[:legacy] < CaseDistributionLever.find_float_lever('minimum_legacy_proportion')
      legacy_proportion = [
        CaseDistributionLever.find_float_lever('minimum_legacy_proportion'),
  ...
  def total_batch_size
    ...
    CaseDistributionLever.find_integer_lever('batch_size_per_attorney')
  end

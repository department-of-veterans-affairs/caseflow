...
class ContestableIssue
  ...
  attr_accessor :rating_issue_reference_id, :decision_date, :description, :ramp_claim_id, :contesting_decision_review,
  ...
  class << self
    def from_rating_issue(rating_issue, contesting_decision_review)
      new(
        ...
        decision_date: rating_issue.promulgation_date.to_date,
    ...
    def from_decision_issue(decision_issue, contesting_decision_review)
      new(
        ...
        decision_date: decision_issue.approx_decision_date,
  ...
  def timely?
    decision_date && contesting_decision_review.timely_issue?(decision_date)
  end
end

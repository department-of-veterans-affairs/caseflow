...
class HearingRequestDocket < Docket
  ...
  def age_of_n_oldest_genpop_priority_appeals(num)
    hearing_distribution_query(
      base_relation: ready_priority_nonpriority_appeals.limit(num), genpop: "only_genpop"
  ...
  def age_of_n_oldest_nonpriority_appeals_available_to_judge(judge, num)
    hearing_distribution_query(
      base_relation: ready_priority_nonpriority_appeals.limit(num), genpop: "only_genpop", judge: judge
  ...
  def genpop_priority_count
    hearing_distribution_query(base_relation: ready_priority_nonpriority_appeals, genpop: "only_genpop").call.count
  end

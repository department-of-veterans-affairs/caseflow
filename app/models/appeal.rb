...
class Appeal < DecisionReview
  ...
  def assigned_to_location
    ...
    # Returns most recently updated open task
    recently_updated_open_task = Task.any_recently_updated(
      tasks.active.visible_in_queue_table_view,
      tasks.on_hold.visible_in_queue_table_view
    )
    return recently_updated_open_task.assigned_to_label if recently_updated_open_task

...
class Veteran < CaseflowRecord
  ...
  def warm_veteran_attr_caches_for_ready_ama_appeals
    ...
    warm_veteran_cache_for_appeals(appeal_ids)
  end

  def warm_veteran_attr_caches_for_ready_legacy_appeals
    #TODO Add Rake Task for one time veteran attribute update
  end

...
class RequestIssue < CaseflowRecord
  ...
  has_many :decision_issues_for_vbms, -> { for_vbms }, class_name: "DecisionIssue", through: :request_decision_issues, source: :decision_issue
  ...
  scope :for_vbms, -> { select(:id, :benefit_type, :closed_status, :contention_reference_id, :contested_decision_issue_id,

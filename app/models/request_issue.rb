...
class RequestIssue < CaseflowRecord
  ...
  class << self
    ...
    def remove_rs_claims_decision_issues_and_request_decision_issues(end_product_establishment_ids=[])
      request_issues = where(end_product_establishment_id: end_product_establishment_ids)

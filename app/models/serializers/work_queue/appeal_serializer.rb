  ...
  attribute :attorney_case_rewrite_details do
    {
      ...
      assigned_judge: object.attorney_rewrite_task_for_appeal&.first&.assigned_by,
      note_from_judge: object.attorney_rewrite_task_for_appeal&.first&.instructions&.first,

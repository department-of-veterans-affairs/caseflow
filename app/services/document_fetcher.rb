...
class DocumentFetcher
  ...
  def save!
    ...
    Rails.logger.info("docs_to_create pre import and pre bulk_merge_and_save: #{docs_to_create}. docs_to_update: #{docs_to_update}")
    ...
    # rubocop:disable Layout/LineLength
    Rails.logger.info("Docs to create post bulk_merge_and_save and pre Document.import: #{docs_to_create} updated_docs: #{updated_docs}")
    # rubocop:enable Layout/LineLength

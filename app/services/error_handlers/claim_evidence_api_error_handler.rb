...
class ErrorHandlers::ClaimEvidenceApiErrorHandler
  ...
  def report_error_to_sentry(error:, error_details:)
    Raven.capture_exception(
      ...
      extra: {
        feature_toggle_enabled_use_ce_api: FeatureToggle.enabled?(:use_ce_api),
        feature_toggle_enabled_send_current_user_cred_to_ce_api: FeatureToggle.enabled?(:send_current_user_cred_to_ce_api),

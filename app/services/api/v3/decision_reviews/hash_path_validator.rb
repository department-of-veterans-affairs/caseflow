...
# see #types_and_paths and #describe_shape_error in Api::V3::DecisionReviews::IntakeParams
#
# examples:
#
#     v = Api::V3::DecisionReviews::HashPathValidator.new(
#       hash: {"a"=>[{"b"=>{"c"=>"pasta"}}]},
#       path: ["a", 0, "b", "c"],
...
class Api::V3::DecisionReviews::HashPathValidator

...
class ExternalApi::VBMSService
  ...
  def self.establish_claim!(veteran_hash:, claim_hash:)
    ...
    request = VBMS::Requests::EstablishClaim.new(veteran_hash, claim_hash, v5: FeatureToggle.enabled?(:claims_service_v5))
  ...
  def self.fetch_contentions(claim_id:)
    ...
    request = VBMS::Requests::ListContentions.new(claim_id, v5: FeatureToggle.enabled?(:claims_service_v5))

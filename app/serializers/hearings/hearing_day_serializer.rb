...
class HearingDaySerializer
  ...
  attribute :judge_first_name do |hearing_day, params|
    RequestStore[:current_user]&.can_view_vlj? ? nil : get_judge_first_name(hearing_day, params)
  end
  attribute :judge_id
  attribute :judge_css_id
  attribute :judge_last_name do |hearing_day, params|
    RequestStore[:current_user]&.can_view_vlj? ? nil : get_judge_last_name(hearing_day, params)
  end
  attribute :lock
  attribute :notes

...
class WarmBgsCachesJob < CaseflowJob
  ...
  def warm_poa_and_cache_for_appeals_for_hearings_priority
    ...
    legacy_metrics_service_segment = "warm_poa_bgs_and_cache_legacy_priority"
    warm_poa_and_cache_for_legacy_appeals(legacy_appeals, legacy_start_time, legacy_metrics_service_segment)
    ...
    ama_metrics_service_segment = "warm_poa_bgs_and_cache_ama_priority"
    warm_poa_and_cache_for_ama_appeals(claimants_for_hearing, ama_start_time, ama_metrics_service_segment)
  end
  ...
  def warm_poa_and_cache_for_appeals_for_hearings_most_recent
    ...
    legacy_metrics_service_segment = "warm_poa_bgs_and_cache_legacy_recent"
    warm_poa_and_cache_for_legacy_appeals(legacy_appeals, legacy_start_time, legacy_metrics_service_segment)
    ...
    ama_metrics_service_segment = "warm_poa_bgs_and_cache_ama_recent"
    warm_poa_and_cache_for_ama_appeals(claimants_for_hearing, ama_start_time, ama_metrics_service_segment)
  end
  ...
  def warm_poa_and_cache_ama_appeals_for_oldest_claimants
    ...
    metrics_service_segment = "warm_poa_claimants_and_cache_ama"
    warm_poa_and_cache_for_ama_appeals(oldest_claimants_with_poa, start_time, metrics_servic_segment)
  end
  ...
  def warm_poa_and_cache_for_legacy_appeals(legacy_appeals, start_time, metrics_service_segment)
    ...
    metrics_service_report_time_segment(segment: metrics_service_segment, start_time: start_time)
  end

  def warm_poa_and_cache_for_ama_appeals(claimants, start_time, metrics_service_segment)

...
class NightlySyncsJob < CaseflowJob
  ...
  def sync_vacols_users
    ...
    custom_metrics_report_time_segment(segment: "sync_users_from_vacols", start_time: user_cache_start)
  ...
  def sync_vacols_cases
    ...
    custom_metrics_report_time_segment(segment: "sync_cases_from_vacols", start_time: start_time)
  rescue StandardError => error
  ...
  def sync_bgs_attorneys
    ...
    custom_metrics_report_time_segment(segment: "sync_bgs_attorneys", start_time: start_time)
  rescue StandardError => error

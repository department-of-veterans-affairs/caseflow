  ...
  def create_conference
    if FeatureToggle.enabled?(:virtual_hearings_use_new_links, user: virtual_hearing.updated_by)
      ...
      if pexip_response.error
        ...
        CustomMetricsService.increment_counter(metric_name: "created_conference.failed", **create_conference_datadog_tags)

        fail pexip_response.error
      end

      CustomMetricsService.increment_counter(metric_name: "created_conference.successful", **create_conference_datadog_tags)

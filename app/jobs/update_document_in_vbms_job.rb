...
class UpdateDocumentInVbmsJob < CaseflowJob
  queue_with_priority :low_priority

  # Purpose: Calls the UpdateDocumentToVbms workflow to update the given document in VBMS
  #
  ...
  def perform(document_id:, initiator_css_id:, application: "idt")
    ...
    UpdateDocumentInVbms.new(document: document).call
  end

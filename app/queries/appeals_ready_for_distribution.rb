  ...
  def self.ama_rows(appeals, docket, sym)
    appeals.map do |appeal|
      ...
      hearing_judge = with_held_hearings(appeal)
      {
        ...
        target_distro_date: appeal.aod? ? target_distro_date(appeal.receipt_date, docket) : "N/A",
        days_before_goal_date: appeal.aod? ? days_before_goal_date(appeal.receipt_date, docket) : "N/A",
        hearing_judge: hearing_judge,

...
docker tag fake:2 008577686731.dkr.ecr.us-gov-west-1.amazonaws.com/facols2:2
if docker push 008577686731.dkr.ecr.us-gov-west-1.amazonaws.com/facols2:2 ; then

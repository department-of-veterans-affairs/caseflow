...
docker build --no-cache -t facols .
docker tag facols:latest 008577686731.dkr.ecr.us-gov-west-1.amazonaws.com/facols:version_4test
if docker push 008577686731.dkr.ecr.us-gov-west-1.amazonaws.com/facols:version_4test ; then

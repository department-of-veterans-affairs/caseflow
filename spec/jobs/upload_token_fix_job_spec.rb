...
describe UploadTokenFixJob, :postres do
  ...
  #   create(
  #     :legacy_appeal,
  #     veteran_file_number: file_number  ******** LegacyAppeals don't have a veteran_file_number ********
  #   )
  # end
  ...
  context "decision_docs_with_errors returns with one or more decision documents" do
    describe "when a 'BVA Decision' document is found and it is present in VBMS" do
    ...
    describe "when a 'BVA Decision' document is found and it is not present in VBMS" do
    ...
    describe "when a 'BVA Decision' document is not found" do
      it "uploads the document to VBMS and clears the error on the decision document" do
  ...
  context "decision_docs_with_errors returns empty" do
    describe "when no errors are detected" do

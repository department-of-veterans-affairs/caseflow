describe EfolderDocumentUploadLogic do
  ...
  subject {EfolderDocumentUploadLogic.new}
  ...
  context "Tests all logic within the perform method" do
    ...
    it "Expects to get appeal_one and appeal_two" do
      appeal_one
      appeal_two
      notification_one_appeal_one
      document_one_appeal_one
      document_two_appeal_one
      expect(subject.perform).to eq([appeal_one, appeal_two])
    ...
    it "Expects to get legacy_appeal_one and legacy_appeal_two" do
      ...
      document_one_legacy_appeal_one
      document_two_legacy_appeal_one
      expect(subject.perform).to eq([legacy_appeal_one, legacy_appeal_two])

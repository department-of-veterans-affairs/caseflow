...
EP_CODES = [
  %w["030HLRNR", "primary", nil, "original", "compensation", "nonrating", "higher_level_review"],
  %w["030HLRNRPMC", "primary", nil, "original", "pension", "nonrating", "higher_level_review"],
  %w["030HLRR", "primary", nil, "original", "compensation", "rating", "higher_level_review"],
  %w["030HLRRPMC", "primary", nil, "original", "pension", "rating", "higher_level_review"],
  %w["040SCNR", "primary", nil, "original", "compensation", "nonrating", "supplemental_claim"],
  %w["040SCNRPMC", "primary", nil, "original", "pension", "nonrating", "supplemental_claim"],
  %w["040SCR", "primary", nil, "original", "compensation", "rating", "supplemental_claim"],
  %w["040SCRPMC", "primary", nil, "original", "pension", "rating", "supplemental_claim"],
  ...
  %w["040BDENR", "primary", nil, "dta", "compensation", "nonrating", "appeal"],
  %w["040BDENRPMC", "primary", nil, "dta", "pension", "nonrating", "appeal"],
  %w["040BDER", "primary", nil, "dta", "compensation", "rating", "appeal"],
  %w["040BDERPMC", "primary", nil, "dta", "pension", "rating", "appeal"],
  %w["040HDENR", "primary", nil, "dta", "compensation", "nonrating", "higher_level_review"],
  %w["040HDENRPMC", "primary", nil, "dta", "pension", "nonrating", "higher_level_review"],
  %w["040HDER", "primary", nil, "dta", "compensation", "rating", "higher_level_review"],
  %w["040HDERPMC", "primary", nil, "dta", "pension", "rating", "higher_level_review"],

...
describe Events::DecisionReviewRemanded::DecisionReviewRemandedParser do
  context "Events::DecisionReviewRemanded::DecisionReviewRemandedParser.load_example" do
    ...
    it "has Claim Review attributes" do
      expect(parser.claim_review_auto_remand).to eq response_hash.claim_review["auto_remand"]

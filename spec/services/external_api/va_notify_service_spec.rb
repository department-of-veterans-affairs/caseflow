...
describe ExternalApi::VANotifyService do
  ...
  context "notifications sent" do
    describe "email" do
      subject do
        ExternalApi::VANotifyService.send_email_notifications(participant_id, email_template_id, status, first_name)
      end
    ...
    describe "sms" do
      subject do
        ExternalApi::VANotifyService.send_sms_notifications(participant_id, sms_template_id, status, first_name)
      end

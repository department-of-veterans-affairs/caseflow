...
RSpec.feature "Cancel certification" do
  ...
  context "Responds to" do
    ...
    scenario "should respond to both html and json format" do
      ...
      page.driver.post "/certification_cancellations", { "certification_cancellation" =>
        { "cancellation_reason" => "VBMS and VACOLS dates didn't match and couldn't be changed",
          "other_reason" => "", "email" => "test@gmail", "certification_id" => "2" } }, format: :html
  ...
  context "Unauthenticated user" do
    ...
    scenario "should reject request for unauthenticated user" do
      visit "certifications/new/#{appeal.vacols_id}"
      expect(page).to_not have_content("Cancel Certification")
      page.driver.post "/certification_cancellations", { "certification_cancellation" =>
        { "cancellation_reason" => "VBMS and VACOLS dates didn't match and couldn't be changed",
          "other_reason" => "", "email" => "unauthenticated@gmail.com", "certification_id" => "2" } }, format: :html
      expect(CertificationCancellation.last).to be_nil
    end
  end
end

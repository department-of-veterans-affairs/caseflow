...
RSpec.describe Api::Events::V1::DecisionReviewCompletedController, type: :controller do
  describe "POST #decision_review_completed" do
        ...
        "request_issues": [
          {
            ...
            "unidentified_issue_text": "User entered description",
    ...
    context "updates sc_unidentified_issue_and_ineligible_legacy_issue" do
      before do
        request.headers["Authorization"] = "Token token=#{api_key.key_string}"
      end

      it "returns success response sc_unidentified_issue_and_ineligible_legacy_issue" do
        ...
        expect(completed_request_issue1.contested_issue_description).to eq(nil)
        ...
        expect(review.auto_remand).to eq(false)

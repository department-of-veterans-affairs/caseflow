    ...
    context "can perform the same case movement actions as a judge" do
      ...
      scenario "on ama appeals" do
        ...
        step "assign an AttorneyTask" do
          ...
          expect(page).to have_content("You have successfully assigned Bob Smithrath's case to #{attorney_one.full_name}")
        ...
        step "reassign an AttorneyTask" do
          ...
          click_on("Assign")
          expect(page).to have_content("You have successfully reassigned Bob Smithrath's case to #{attorney_two.full_name}")

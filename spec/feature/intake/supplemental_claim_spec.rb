...
feature "Supplemental Claim Intake", :all_dbs do
  ...
  it "Creates an end product" do
    ...
    expect(page).to_not have_content("Please select the claimant listed on the form. If the claimant is not listed, please select \"Claimant not listed\" and add their information in the next step.")

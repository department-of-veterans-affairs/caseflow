...
describe "Fixing dispatched appeals" do
  ...
  describe "dispatched appeal without decision document" do
    ...
    it "restores decision_document and fixes task tree" do
      ...
      parent_dispatch_task = BvaDispatchTask.create!(appeal: appeal, assigned_to: BvaDispatch.singleton, parent: appeal.root_task)
      ...
      Task.find(2001402014).cancelled!  # changed from 'completed' status to avoid future confusion
      ...
      orig_dispatch_task_id = 2000979806
      ...
      # 5. Recreate and reattach the decision document to the appeal because it was sent to the Veteran and no edits have been made
      params = {
        appeal_id: appeal.id,
        appeal_type: "Appeal",
        citation_number: "A20011064",
        decision_date: DateTime.new(2020,06,26),
        redacted_document_location:  "\\vacohsm01.dva.va.gov\vaco_workgroups\BVA\archdata\arch2006\A20011064.txt",
        submitted_at: DateTime.new(2020,06,26,16,54,45),
        attempted_at: DateTime.new(2020,06,26,16,54,46),
        processed_at: DateTime.new(2020,06,26,16,55,05),
        uploaded_to_vbms_at: DateTime.new(2020,06,26,16,54,50),
        last_submitted_at: DateTime.new(2020,06,26,16,54,45)
      }

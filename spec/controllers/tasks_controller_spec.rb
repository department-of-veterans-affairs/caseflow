  ...
  describe "GET tasks/xxx" do
    ...
    context "when user is an attorney" do
      ...
      it "should process the request succesfully" do
        ...
        expect(response_body.first["attributes"]["veteran_name"]).to_not be nil
        expect(response_body.first["attributes"]["veteran_file_number"]).to_not be nil
        ...
        expect(response_body.second["attributes"]["veteran_name"]).to_not be nil
        expect(response_body.second["attributes"]["veteran_file_number"]).to_not be nil
      end
    end

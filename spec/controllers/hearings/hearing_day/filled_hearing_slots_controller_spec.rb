  ...
  describe "#index" do
    ...
    context "hearing day with multiple hearings" do
      ...
      it "returns correct data", :aggregate_failures do
        ...
        slots = Time.zone.now.in_time_zone("America/New_York").zone == "EDT" ? ["09:30 AM Eastern Time (US & Canada)", "12:00 PM Eastern Time (US & Canada)"] : ["08:30 AM Eastern Time (US & Canada)", "12:00 PM Eastern Time (US & Canada)"]

RSpec.describe Hearings::SchedulePeriodsController, type: :controller do
  ...
  context "show judge" do
    let!(:co_hearing_days) do
      create(:hearing_day, request_type: "V", scheduled_for: Date.new(2018, 5, 1), regional_office: "RO13")
      create(:hearing_day, request_type: "V", scheduled_for: Date.new(2018, 5, 7), regional_office: "RO13")
      create(:hearing_day, request_type: "V", scheduled_for: Date.new(2018, 5, 16), regional_office: "RO13")
      create(:hearing_day, request_type: "V", scheduled_for: Date.new(2018, 5, 22), regional_office: "RO13")
      create(:hearing_day, request_type: "V", scheduled_for: Date.new(2018, 5, 23), regional_office: "RO13")
    end
  ...
  context "assign judges to full schedule for a schedule period" do
    let!(:hearing_days) do
      create(:hearing_day, request_type: "V", scheduled_for: Date.new(2018, 5, 1), regional_office: "RO13")
      create(:hearing_day, request_type: "V", scheduled_for: Date.new(2018, 5, 8), regional_office: "RO13")
      create(:hearing_day, request_type: "V", scheduled_for: Date.new(2018, 5, 15), regional_office: "RO13")
      create(:hearing_day, request_type: "V", scheduled_for: Date.new(2018, 5, 22), regional_office: "RO13")
      create(:hearing_day, request_type: "V", scheduled_for: Date.new(2018, 5, 29), regional_office: "RO13")
    end

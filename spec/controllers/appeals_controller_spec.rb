    ...
    let!(:notifications) do
      [
        create(:notification, appeals_id: legacy_appeal.vacols_id, appeals_type: legacy_appeals_type,
                              event_date: 6.days.ago, event_type: Constants.EVENT_TYPE_FILTERS.appeal_docketed, notification_type: "SMS",
        ...
        create(:notification, appeals_id: ama_appeal.uuid, appeals_type: ama_appeals_type,
                              event_date: 6.days.ago, event_type: Constants.EVENT_TYPE_FILTERS.hearing_scheduled, notification_type: "Email",
        ...
        create(:notification, appeals_id: legacy_appeal_without_claimant.vacols_id, appeals_type: legacy_appeals_type,
                              event_date: 6.days.ago, event_type: Constants.EVENT_TYPE_FILTERS.hearing_scheduled, notification_type: "SMS",

    ...
    context "when request header contains valid token" do
      ...
      context "and user is an attorney" do
        ...
        it "returns a list of active assigned appeals" do
          ...
          expect(AttorneyCaseReview.distinct.pluck(:appeal_type)).to match_array %w[Appeal LegacyAppeal]
          expect(AttorneyCaseReview.distinct.pluck(:appeal_id).size).to eq 1

...
describe Intake, :postgres do
  ...
  context ".build" do
    subject { Intake.build(form_type: form_type, search_term: veteran_file_number, user: user) }
  ...
  context "Homelessness field" do
      scenario "is visible due to FeatureToggle being enabled" do
        ...
        expect(page).to have_content("Did the claimant check the \"I am experiencing homelessness\" box on the form?")
      end
      ...
      scenario "is not visible due to FeatureToggle being disabled" do
        ...
        expect(page).to have_current_path("/intake/review_request")
        expect(page).to_not have_content("Did the claimant check the \"I am experiencing homelessness\" box on the form?")
      end
    end
end

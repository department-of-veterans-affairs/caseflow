    ...
    describe ".singleton" do
      ...
      describe ".queue_tabs" do
        it "returns the expected tabs for use in the VHA CSP organization's queue" do
          expect(vha_csp.queue_tabs).to match_array [VhaCaregiverSupportUnassignedTasksTab, VhaCaregiverSupportInProgressTasksTab, VhaCaregiverSupportCompletedTasksTab]
        end
      end

...
shared_examples "fails with wrong user" do
...
shared_examples "appeal past distribution fails" do
...
shared_examples "wrong parent task type" do
...
shared_examples "succeeds when there's a nonblocking mail task" do
  before do

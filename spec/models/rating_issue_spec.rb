...
describe RatingIssue do
  ...
  context "#active_review_of_duplicate_issue" do
    before do
    ...
    it "returns review title if an active RequestIssue already exists with the same reference_id" do
      ...
      expect(rating_issue.active_review_of_duplicate_issue).to eq("Supplemental Claim")
    end
    ...
    context "removed issue" do
      ...
      it "returns nil if the issue has been removed" do
        ...
        expect(rating_issue.active_review_of_duplicate_issue).to be_nil
      end
    end

...
describe RequestIssue do
  ...
  context "#previous_request_issue" do
    ...
    it "looks up the chain to the immediately previous request issue" do
      ...
      expect(rating_request_issue.previous_request_issue).to eq(prior_request_issue)
    end
  ...
  context "#validate_eligibility!" do
    ...
    it "flags prior HLR" do
      ...
      expect(rating_request_issue.prior_higher_level_review?).to eq(true)
      expect(rating_request_issue.ineligible_request_issue_id).to eq(prior_request_issue.id)
    end
  end
end

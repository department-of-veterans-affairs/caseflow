  ...
  context "rebuild_and_save_links" do
    ...
    context "with new link generation virtual hearing" do
      ...
      it "rebuilds and saves the links as expected" do
        ...
        expect(virtual_hearing.alias_with_host).to eq alias_with_host
        expect(virtual_hearing.host_pin_long).to eq host_pin_long
        expect(virtual_hearing.guest_pin_long).to eq guest_pin_long
      end
    end
  end
end

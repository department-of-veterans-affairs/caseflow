...
describe CertificationStats, :postgres do
  ...
  let(:monthly_stats) { Rails.cache.read("CertificationStats-2016-2") }
  let(:weekly_stats) { Rails.cache.read("CertificationStats-2016-w07") }
  let(:daily_stats) { Rails.cache.read("CertificationStats-2016-2-17") }
  let(:hourly_stats) { Rails.cache.read("CertificationStats-2016-2-17-15") }
  let(:prev_weekly_stats) { Rails.cache.read("CertificationStats-2016-w06") }

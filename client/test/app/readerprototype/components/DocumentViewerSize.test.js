...
describe("Open Document", () => {
  it("Verify that only one Column shows by default for large screens", async () => {
  ...
  // Check the current value of content-visibility
  expect(styles.contentVisibility).toBe('auto'); // could be 'visible', 'hidden', or 'auto'

  // Optional: Check if the element is actually visible based on its size

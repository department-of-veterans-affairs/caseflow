...
describe('Details', () => {
  ...
  describe('TranscriptiomFormSection', () => {
    describe('pexip hearing', () => {
      test('Displays transcription section but not transcription files table or webex section for AMA hearings', () => {
        ...
        expect(screen.getByRole('heading', { name: 'Transcription Details' })).toBeInTheDocument();
        expect(screen.queryByTestId('transcription-details-webex')).toBeNull();
    ...
    describe('webex hearing', () => {
      test('Displays transcription section, including transcription files table, and webex section for AMA hearings', () => {
        const { container } = customRender(
          <Details
            hearing={defaultHearing}
            saveHearing={saveHearingSpy}
        ...
        expect(screen.getByRole('heading', { name: 'Transcription Details' })).toBeInTheDocument();
        expect(screen.getByTestId('transcription-details-webex')).toBeInTheDocument();

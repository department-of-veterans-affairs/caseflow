...
it('shows file size', () => {
  ...
  const { container } = render(<DocSizeIndicator docSize="1024" browserSpeedInBytes={downloadSpeedInBytes} warningThreshold={1} />);
...
it('handles empty strings', () => {
  const connectionSpeed = 1;
  const downloadSpeedInBytes = connectionSpeed * 125000;
  const { container } = render(<DocSizeIndicator docSize="" browserSpeedInBytes={downloadSpeedInBytes} warningThreshold={1} />);
...
it('handles null', () => {
  const connectionSpeed = 1;
  const downloadSpeedInBytes = connectionSpeed * 125000;
  const { container } = render(<DocSizeIndicator docSize={null} browserSpeedInBytes={downloadSpeedInBytes} warningThreshold={1} />);
...
it('shows a file size warning when file size is large', () => {
  ...
  const { getByTitle } = render(<DocSizeIndicator docSize={fileSize} browserSpeedInBytes={downloadSpeedInBytes} warningThreshold={1} />);

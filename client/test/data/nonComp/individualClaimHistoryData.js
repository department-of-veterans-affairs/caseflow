  ...
  changeHistory: {
    ...
    events: [
      ...
      },
      {
        ...
        eventType: 'pending',
        eventUser: 'System',
        eventDate: '2024-07-18T20:33:29.146Z',
        claimType: 'Higher-Level Review',
        readableEventType: 'Claim status - Pending',
        claimantName: 'Bob Smithhansen',
        details: {
          benefitType: 'vha',
          issueType: null,
          issueDescription: null,
        ...
        modificationRequestDetails: {
          ...
          modificationRequestReason: null,
          issueModificationRequestWithdrawalDate: null,
          removeOriginalIssue: null,
          issueModificationRequestStatus: null,
          requestor: null,
          decider: null,
          decidedAtDate: null,
          decisionReason: null
        },
        id: '841d036d-0ef3-46ad-a180-6c60a2283d87',
        type: 'change_history_event'
      },
      {
        taskID: 81,
        ...
        eventUser: 'M. Mann',
        eventDate: '2024-07-19T08:38:14.989Z',
        claimType: 'Higher-Level Review',
        readableEventType: 'Edit of request - issue modification',
        claimantName: 'Bob Smithhansen',
        details: {
          benefitType: 'vha',
          issueType: 'Other',
          issueDescription: 'jjjj',
          decisionDate: '2024-07-01',
          disposition: null,
          decisionDescription: null,
          dispositionDate: '2024-07-19',
          withdrawalRequestDate: '2024-07-21T20:26:42.019Z'
        },
        modificationRequestDetails: {
          requestType: 'modification',
          benefitType: 'vha',
          newIssueType: 'Continuing Eligibility/Income Verification Match (IVM)',
          newIssueDescription: 'Modification test - modification 1',
          newDecisionDate: '2024-07-09',
          modificationRequestReason: 'this is a modification test - modification 1',
          issueModificationRequestWithdrawalDate: null,
          removeOriginalIssue: false,
          issueModificationRequestStatus: 'approved',
          requestor: 'Monte Mann',
          decider: 'VHAADMIN',
          decidedAtDate: '2024-07-19T08:40:39.543Z',
          decisionReason: null
        },
        id: '19c63a8e-f7bc-4e61-8669-b64735ee8d07',
        type: 'change_history_event'
      },
      {
        taskID: 81,
        ...
        eventUser: 'V. ',
        eventDate: '2024-07-19T08:40:39.543Z',
        claimType: 'Higher-Level Review',
        readableEventType: 'Approval of request - issue modification',
        claimantName: 'Bob Smithhansen',
        details: {
          benefitType: 'vha',
          issueType: 'Other',
        ...
        id: '4f4e6bde-3554-4a68-8acd-f53c65389227',
        type: 'change_history_event'
      },
      {
        taskID: 81,
        ...
        eventUser: 'V. ',
        eventDate: '2024-07-18T20:33:29.170Z',
        claimType: 'Higher-Level Review',
        readableEventType: 'Requested issue modification',
        claimantName: 'Bob Smithhansen',
        details: {
          benefitType: 'vha',
          issueType: 'Other',
        ...
        modificationRequestDetails: {
          ...
          benefitType: 'vha',
          newIssueType: 'Continuing Eligibility/Income Verification Match (IVM)',
          newIssueDescription: 'Modification test',
          newDecisionDate: '2024-07-09',
          modificationRequestReason: 'this is a modification test',
          issueModificationRequestWithdrawalDate: null,
          removeOriginalIssue: false,
          issueModificationRequestStatus: 'approved',
          requestor: 'Monte Mann',
        ...
        id: 'd3ab8e79-d662-4bde-aed8-d8970a292f3f',
        type: 'change_history_event'
      }
    ],

...
class CertificationHelp extends React.Component {
  ...
  render() {
    ...
    return <div className="cf-help-content">
      ...
      <p>The Notes listed on the Daily Docket are pulled from VACOLS. This information is usually updated by the Hearing Coordinator at the Regional Office. The Notes include contextual information related to the hearing.
      </p>
      ...
      <p>You can return to the Upcoming Hearing Days page from any page by clicking on the Caseflow Hearing Prep icon located in the upper left-hand corner of the screen or by clicking the <b>Back to Your Hearing Days</b> link located on the bottom left-hand corner of the Daily Docket page.
      </p>
      ...
      <p>The Issue Descriptions on the Hearing Worksheet are pulled from VACOLS.
      </p>

      <h2 id="information-on-hearing-worksheet-saved-vacols?">13. What information on the Hearing Worksheet is saved to VACOLS?</h2>

      <p>None of the information on the Hearing Worksheet is saved to VACOLS. Only the information changed on the Daily Docket is saved back to VACOLS.
      </p>

      <h2 id="preliminary-mpressions-boxes">14. How are the Preliminary Impressions boxes on the Hearing Worksheet used?</h2>

      <p>The Preliminary Impressions boxes are used to indicate your first thoughts about the issues associated with the case. You may select more than one or none at all. The issue indicators are Re-Open, Dismiss, Allow, Deny, Remand, and VHA.
      </p>

      <h2 id="case-summary-category-in-reader">15. What does the Case Summary category in Reader represent?</h2>

      <p>The Case Summary category is used to identify the key documents used by a judge when preparing for a hearing. The list includes the Notice of Disagreement, Statement of Case, VA 9 Appeal to Board of Appeals, VA8 Certification of Appeal, BVA Decision, Supplement Statement of Case, DD Form 214 – Certificate of Release or Discharge from Active Duty, VA 21-526EZ - Fully Developed Claim (Compensation), VA 21-527EZ - Fully Developed Claim (Pension), and the Rating Decision.
      </p>

      <h2 id="documents-in-reader-come">16. Where do the documents in Reader come from?</h2>

      <p>The documents used in Reader come from VBMS.
      </p>

      <h2 id="encounter-problems">17. What should I do if I encounter problems?</h2>

      <p>If you encounter any problems while using Hearing Prep, contact the Caseflow Product Support Team by calling 1-844-876-5548 or sending an email to <a href="mailto: caseflow@va.gov">caseflow@va.gov</a>. They can be reached from 8:00AM to 8:00PM EST.
      </p>

      <h2 id="share-feedback">18. How do I share my feedback for improving Hearing Prep?</h2>

      <p>You can use the "Send feedback" link located in the dropdown menu next to your username, or the “Send feedback” link located at the bottom right-hand corner of the screen, to share your ideas for improving Hearing Prep.
      </p>

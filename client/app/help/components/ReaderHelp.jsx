...
class CertificationHelp extends React.Component {
  ...
  render() {
    ...
    return <div className="cf-help-content">
      ...
      <p>Here you will find <a href="#training-videos"> Training Videos</a> and <a href="#faq"> FAQs</a> for Reader. If you need help with a topic not covered on this page, please contact the Caseflow team

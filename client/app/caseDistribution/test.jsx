...
import Footer from '@department-of-veterans-affairs/caseflow-frontend-toolkit/components/Footer';import CaseSearchLink from '../components/CaseSearchLink';
                      ...
                      return (
                        <div>
                          ...
                          <h2 id='levers'> Case Distribution Levers </h2>
                            <table id="case-table-description" className="usa-table-borderless undefined" style={tablestyle}>
                              <thead>
                                <tr>
                                  <td> ID </td>
                                  <td> Title </td>
                          ...
                          <ul>
                            <li>
                              <a href="/appeals-ready-to-distribute?csv=1"><button className="btn btn-primary">Download Appeals Ready to Distribute CSV</button></a>
                            </li>
                            <li>
                              <a href="/appeals-distributed?csv=1"><button className="btn btn-primary">Download Distributed Appeals CSV</button></a>
                            </li>
                          </ul>
                          <hr/>

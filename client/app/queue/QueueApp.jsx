      ...
      <AppFrame wideApp>
        ...
        <div className="cf-wide-app">
          ...
          <Switch>
            ...
            />
            <Route
              path={`/queue/appeals/:appealId/tasks/:taskId/${TASK_ACTIONS.VHA_SEND_TO_BOARD_INTAKE.value
                }`}
            ...
            <PageRoute
              exact
              path={`/queue/appeals/:appealId/tasks/:taskId/${TASK_ACTIONS.READY_FOR_REVIEW.value
                }`}

...
const QueueTableBuilder = (props) => {
  ...
  const calculateActiveTabIndex = (config) => {
    ...
    console.log("passed calculate active tab index")
  ...
  console.log("passed queueConfig")

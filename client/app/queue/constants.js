...
export const ACTIONS = {
  ...
  RECEIVE_ALL_ORGANIZATIONS: 'RECEIVE_ALL_ORGANIZATIONS',
  ERROR_LOADING_ORGANIZATIONS: 'ERROR_LOADING_ORGANIZATIONS',
  RECEIVE_ALL_ORGANIZATION_USERS: 'RECEIVE_ALL_ORGANIZATION_USERS',
  ERROR_LOADING_ORGANIZATION_USERS: 'ERROR_LOADING_ORGANIZATION_USERS'
};

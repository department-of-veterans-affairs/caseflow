...
const NotificationTable = ({ appealId, modalState, openModal, closeModal }) => {
  ...
  const createColumnObject = (column) => {
    const functionForColumn = {
      ...
      [NOTIFICATION_CONFIG.COLUMNS.EVENT_TYPE.name]: hearingDateColumn(notificationList, modalState, openModal, handleNotification),
      [NOTIFICATION_CONFIG.COLUMNS.NOTIFICATION_DATE.name]: judgeColumn(notificationList),
      [NOTIFICATION_CONFIG.COLUMNS.NOTIFICATION_TYPE.name]: hearingTypeColumn(notificationList),
      [NOTIFICATION_CONFIG.COLUMNS.RECIPIENT_INFORMATION.name]: postponementReasonColumn(notificationList),

...
// possible solution? Seperate the utilities that build the table from the ones responsible for populating it

// remove all of the columns from TaskTable and put them here. (do something similar for all tables)

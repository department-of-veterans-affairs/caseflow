...
import {
  DOCKET_SWITCH_RECOMMENDATION_ALERT_TITLE,
  DOCKET_SWITCH_RECOMMENDATION_ALERT_MESSAGE,
} from '../../../../COPY';
...
export const RecommendDocketSwitchContainer = () => {
  ...
  const handleSubmit = async (formData) => {
    ...
    const successMessage = {
      title: sprintf(DOCKET_SWITCH_RECOMMENDATION_ALERT_TITLE, appeal.appellantFullName, formData.judge.label),
      detail: DOCKET_SWITCH_RECOMMENDATION_ALERT_MESSAGE,
    };

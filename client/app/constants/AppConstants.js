...
export const LOADING_INDICATOR_COLOR_EFOLDER = '#EA6C4C';
export const LOADING_INDICATOR_COLOR_FEEDBACK = '#65E1CA';
export const LOADING_INDICATOR_COLOR_HEARING_PREP = '#68BD07';
export const LOADING_INDICATOR_COLOR_READER = '#346408';

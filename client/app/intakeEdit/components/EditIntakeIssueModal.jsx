        ...
        buttons={[
          ...
          { classNames: ['usa-button-blue', 'save-issue'],
            ...
            onClick: () => {
              ...
              if (!currentIssue?.mstChecked && mstChecked &&  mstJustification === '' && justificationReason) {
                return;
              }
              if (!currentIssue?.pactChecked && pactChecked && pactJustification === '' && justificationReason) {
                return;
              }

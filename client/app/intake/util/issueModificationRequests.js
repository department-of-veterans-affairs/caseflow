...
export const formatIssueModificationRequests = (issueModificationRequests) => {
  ...
  return issueModificationRequests.map((modificationRequest) => {
    return {
      ...
      removeOriginalIssue: modificationRequest.removeOriginalIssue,
      ...
      decisionReason: modificationRequest.decisionReason,
      requestReason: modificationRequest.requestReason,

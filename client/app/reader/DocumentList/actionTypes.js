...
export const SET_RECEIPT_DATE_FILTER = 'SET_RECEIPT_DATE_FILTER';

// Claim evidence filter
export const SET_CLAIM_EVIDENCE_DOCS = 'SET_CLAIM_EVIDENCE_DOCS';
export const CLEAR_CLAIM_EVIDENCE_DOCS = 'CLEAR_CLAIM_EVIDENCE_DOCS';
// Document filter

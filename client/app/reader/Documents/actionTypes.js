...
// Description
export const CHANGE_PENDING_DOCUMENT_DESCRIPTION = 'CHANGE_PENDING_DOCUMENT_DESCRIPTION';
export const RESET_PENDING_DOCUMENT_DESCRIPTION = 'RESET_PENDING_DOCUMENT_DESCRIPTION';
...
export const GENERATE_AUTO_TAGS = 'GENERATE_AUTO_TAGS';
export const GENERATE_AUTO_TAGS_SUCCESS = 'GENERATE_AUTO_TAGS_SUCCESS';
export const GENERATE_AUTO_TAGS_FAILURE = 'GENERATE_AUTO_TAGS_FAILURE';

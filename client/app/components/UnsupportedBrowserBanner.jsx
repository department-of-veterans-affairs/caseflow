...
export default class UnsupportedBrowserBanner extends React.PureComponent {
  render() {
    ...
    const appName = 'Hearing Prep';
    const message = <span> To access {appName}, you must use Chrome as your browser.<br />
    If you need to install Chrome on your computer, please call the <br />
    VA Enterprise Service Desk at
      <a className="hearing-status-message" href="tel:855-673-4357"> 855-673-4357 </a>.</span>;

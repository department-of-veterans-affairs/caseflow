...
export const SortArrowDownIcon = (props) => {
  ...
  return <svg height={size} className={className} viewBox="0 0 16 9" version="1.1" xmlns="http://www.w3.org/2000/svg" role="img" aria-labelledby={`${title}`}>

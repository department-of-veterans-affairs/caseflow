...
export const UnselectedFilterIcon = (props) => {
  const { getRef, className, color, strokeColor, selected, size, ...restProps } = props;
  ...
  <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
    <g>
      <rect stroke={selected ? '#0071bc' : strokeColor} fill={color} fillRule="nonzero" x="0.5" y="0.5" width="20" height="20" rx="2"></rect>
      ...
      16.2335889,6.4 Z" fill={selected ? '#0071bc' : strokeColor}></path>
    </g>
  </g>
</svg>;
};

    ...
    <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
      <g>
        <rect className="unselected-filter-icon-border"
          fill={color} fillRule="nonzero" x="0.5" y="0.5" width="20" height="20" rx="2"></rect>
        ...
        L15.9697874,5.83333333 C16.303936,5.83333333 16.4446301,6.2 16.2335889,6.4 Z" fill={strokeColor}></path>
      </g>
    </g>
  </svg>;
};

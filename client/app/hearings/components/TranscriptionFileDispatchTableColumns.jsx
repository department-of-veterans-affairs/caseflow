...
export const returnDateColumn = () => {
  return {
    header: (
      <p {...styles.headerWithIcon}>
        {COPY.TRANSCRIPTION_FILE_DISPATCH_RETURN_DATE_COLUMN_NAME}
      </p>
    ),
    ...
    anyFiltersAreSet:
      TRANSCRIPTION_DISPATCH_CONFIG.COLUMNS.RETURN_DATE.anyFiltersAreSet,
...
export const expectedReturnDateColumn = () => {
  return {
    ...
    anyFiltersAreSet:
      TRANSCRIPTION_DISPATCH_CONFIG.COLUMNS.EXPECTED_RETURN_DATE
        .anyFiltersAreSet,
    columnName:
      COPY.TRANSCRIPTION_FILE_DISPATCH_EXPECTED_RETURN_DATE_COLUMN_NAME,
...
export const statusColumn = (currentTab) => {
  ...
  return {
    ...
    valueFunction: (row) => {
      let status =
        currentTab === COPY.TRANSCRIPTION_DISPATCH_COMPLETED_TAB ||
        currentTab === "All"
          ? row.fileStatus
          : row.status;

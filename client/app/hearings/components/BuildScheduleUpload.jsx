    ...
    return <div>{ SPREADSHEET_TYPES.RoSchedulePeriod.display }
      ...
      <div>
        {this.props.uploadRoCoFormErrors &&
          <span className="usa-input-error-message" tabIndex={0}>{this.getErrorMessage(this.props.uploadRoCoFormErrors)}</span>}
        <InlineForm>
    ...
    return <div>{ SPREADSHEET_TYPES.JudgeSchedulePeriod.display }
      ...
      <div>
        {this.props.uploadJudgeFormErrors &&
          <span className="usa-input-error-message" tabIndex={0}>{this.getErrorMessage(this.props.uploadJudgeFormErrors)}</span>}
        <InlineForm>
